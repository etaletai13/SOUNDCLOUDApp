;(function () {
  ...
  var z,
    ...
    DI = function () {
      ...
      typeof Array.prototype[w] !== 'function' &&
    ...
    z0 = function (w, F) {
      if (F) {
        ...
        Y != g &&
          Y != null &&
          cW(X, c, { configurable: !0, writable: !0, value: Y })
      }
    }
  z0('Promise', function (w) {
    ...
    g.prototype.s8 = function (w) {
      ...
      } else if (w instanceof g) this.o(w)
      else {
        a: switch (typeof w) {
          case 'object':
            var F = w != null
    ...
    g.prototype.L = function (w) {
      ...
      typeof F === 'function' ? this.B(F, w) : this.Y(w)
    }
    ...
    g.prototype.Ms = function (w, F) {
      ...
      var c = this
      this.R == null ? Y.A(X) : this.R.push(X)
    }
    g.resolve = X
    g.reject = function (w) {
    ...
    g.race = function (w) {
      return new g(function (F, c) {
        for (var g = T0(w), Y = g.next(); !Y.done; Y = g.next()) {
          X(Y.value).Ms(F, c)
        }
      })
    }
  ...
  var dk
  if (typeof Object.setPrototypeOf === 'function') dk = Object.setPrototypeOf
  else {
    var j5
    a: {
      var Er = { my: !0 },
        ...
        for (var X in F) {
          if (X != 'prototype') {
            if (Object.defineProperties) {
              var c = Object.getOwnPropertyDescriptor(F, X)
      ...
      (function () {
        ...
        try {
          var F = Object.seal({}),
            X = Object.seal({}),
            c = new w([[F, 2], [X, 3]])
          if (c.get(F) != 2 || c.get(X) != 3) return !1
          c['delete'](F)
          c.set(X, 4)
          return !c.has(F) && c.get(X) == 4
        } catch (K) {
          return !1
        }
      })()
  ...
  z0('Map', function (w) {
    if (
      (function () {
        ...
        try {
          ...
          var c = X.entries(),
            g = c.next()
          if (g.done || g.value[0] != F || g.value[1] != 's') return !1
          g = c.next()
          return g.done ||
            g.value[0].x != 4 ||
            g.value[1] != 't' ||
    ...
    X.prototype['delete'] = function (w) {
      ...
      return w.QJ && w.list
        ...
        w.list.length || delete this.A[w.id],
        (w.QJ.E8.next = w.QJ.next),
        (w.QJ.next.E8 = w.QJ.E8),
        (w.QJ.head = null),
        this.size--,
        !0)
        : !1
    ...
    X.prototype.forEach = function (w, F) {
      for (var X = this.entries(), c; !(c = X.next()).done;) {
        ;(c = c.value), w.call(F, c[1], c[0], this)
      }
    }
    ...
    var c = function (w, X) {
        var c = X && typeof X
        c == 'object' || c == 'function'
          ? F.has(X) ? (c = F.get(X)) : ((c = '' + ++y), F.set(X, c))
          : (c = 'p_' + X)
        var g = w.A[c]
        if (g && Ql(w.A, c)) {
          for (var Y = 0; Y < g.length; Y++) {
            var p = g[Y]
            if ((X !== X && p.key !== p.key) || X === p.key) {
              return { id: c, list: g, index: Y, QJ: p }
            }
          }
        }
      ...
      g = function (w, F) {
        ...
        return p7(function () {
          if (X) {
            ...
            for (; X.next != X.head;) {
              return (X = X.next), { done: !1, value: F(X) }
            }
            X = null
          }
  ...
  z0('Array.prototype.fill', function (w) {
    return (
      ...
      function (w, X, c) {
        var F = this.length || 0
        X < 0 && (X = Math.max(0, F + X))
        if (c == null || c > F) c = F
        c = Number(c)
        c < 0 && (c = Math.max(0, F + c))
    ...
    return (
      ...
      function (w, X, c) {
        ...
        if (typeof Y === 'function') {
          w = Y.call(w)
          for (var y = 0; !(Y = w.next()).done;) {
            F.push(X.call(c, Y.value, y++))
          }
        } else {
          for (Y = w.length, y = 0; y < Y; y++) F.push(X.call(c, w[y], y))
        }
        return F
      }
    )
  ...
  var rk = rk || {},
    ...
    n7 = function (w) {
      w = w.split('.')
      for (var F = d, X = 0; X < w.length; X++) {
        if (((F = F[w[X]]), F == null)) return null
      }
      return F
    },
    A = a(),
    ...
    G0 = function (w) {
      ...
      if (F == 'object') {
        if (w) {
          ...
          if (X == '[object Window]') return 'object'
          if (
            X == '[object Array]' ||
            (typeof w.length === 'number' &&
              typeof w.splice !== 'undefined' &&
              typeof w.propertyIsEnumerable !== 'undefined' &&
              !w.propertyIsEnumerable('splice'))
          ) {
            return 'array'
          }
          if (
            X == '[object Function]' ||
            (typeof w.call !== 'undefined' &&
              typeof w.propertyIsEnumerable !== 'undefined' &&
              !w.propertyIsEnumerable('call'))
          ) {
            return 'function'
          }
        } else return 'null'
      } else if (F == 'function' && typeof w.call === 'undefined') {
        return 'object'
      }
      return F
    },
    ...
    ZI = function (w) {
      var F = G0(w)
      return F == 'array' || (F == 'object' && typeof w.length === 'number')
    },
    h = function (w) {
      return G0(w) == 'function'
    },
    V = function (w) {
      var F = typeof w
      return (F == 'object' && w != null) || F == 'function'
    },
    iF = function (w) {
      return w[C7] || (w[C7] = ++tu)
    },
    C7 = 'closure_uid_' + ((1e9 * Math.random()) >>> 0),
    tu = 0,
    Ur = function (w, F, X) {
    ...
    RO = function (w, F, X) {
      ...
      if (arguments.length > 2) {
        ...
        return function () {
          ...
          Array.prototype.unshift.apply(X, c)
          return w.apply(F, X)
        }
      }
      return function () {
    ...
    oO = function (w) {
      if (d.execScript) d.execScript(w, 'JavaScript')
      else if (d.eval) {
        if (Ju == null) {
          try {
            d.eval('var _evalTest_ = 1;')
          } catch (c) {}
          if (typeof d._evalTest_ !== 'undefined') {
            try {
              delete d._evalTest_
            } catch (c) {}
            Ju = !0
    ...
    N9 = function (w, F) {
      ...
      X[0] in c ||
        ...
        c.execScript('var ' + X[0])
      for (var g; X.length && (g = X.shift());) {
        !X.length && E(F)
          ? (c[g] = F)
          : c[g] && c[g] !== Object.prototype[g] ? (c = c[g]) : (c = c[g] = {})
      }
    },
    O = function (w, F) {
      function X () {}
  ...
  var bF = function (w) {
    if (Error.captureStackTrace) Error.captureStackTrace(this, bF)
    else {
      var F = Error().stack
      F && (this.stack = F)
    }
  ...
  var S5
  var WW = Array.prototype.indexOf
      ? function (w, F) {
        return Array.prototype.indexOf.call(w, F, void 0)
      }
      : function (w, F) {
        if (I(w)) return I(F) && F.length == 1 ? w.indexOf(F, 0) : -1
    ...
    P = Array.prototype.forEach
      ...
      : function (w, F, X) {
        for (
          var c = w.length, g = I(w) ? w.split('') : w, Y = 0;
          Y < c;
          Y++
        ) {
          Y in g && F.call(X, g[Y], Y, w)
        }
      },
    lF = Array.prototype.filter
      ...
      : function (w, F) {
        for (
          var X = w.length, c = [], g = 0, Y = I(w) ? w.split('') : w, y = 0;
          y < X;
          y++
        ) {
          if (y in Y) {
    ...
    q9 = Array.prototype.map
      ? function (w, F) {
        return Array.prototype.map.call(w, F, void 0)
      }
      : function (w, F) {
        for (
          var X = w.length, c = Array(X), g = I(w) ? w.split('') : w, Y = 0;
          Y < X;
          Y++
        ) {
          Y in g && (c[Y] = F.call(void 0, g[Y], Y, w))
        }
        return c
      },
    wp = Array.prototype.some
      ? function (w, F, X) {
      ...
      : function (w, F, X) {
        for (
          ...
          if (Y in g && F.call(X, g[Y], Y, w)) return !0
        }
        return !1
      },
    FS = Array.prototype.every
      ? function (w, F) {
        return Array.prototype.every.call(w, F, void 0)
      }
      : function (w, F) {
        for (
          var X = w.length, c = I(w) ? w.split('') : w, g = 0;
          g < X;
          g++
        ) {
          if (g in c && !F.call(void 0, c[g], g, w)) return !1
        }
        return !0
      },
    cj = function (w) {
      var F = XS('grecaptcha-badge'),
        X = 0
      P(
        F,
        function (F, g, Y) {
    ...
    Yg = function (w) {
      a: {
        var F = gp
        for (var X = w.length, c = I(w) ? w.split('') : w, g = 0; g < X; g++) {
          if (g in c && F.call(void 0, c[g], g, w)) {
            F = g
            break a
          }
        }
      ...
      return F < 0 ? null : I(w) ? w.charAt(F) : w[F]
    },
    yz = function (w, F) {
      return WW(w, F) >= 0
    },
    aI = function (w) {
      if (!k(w)) for (var F = w.length - 1; F >= 0; F--) delete w[F]
      w.length = 0
    },
    Dc = function (w, F) {
      var X = WW(w, F),
        c
      ;(c = X >= 0) && Array.prototype.splice.call(w, X, 1)
      return c
    },
    pq = function (w) {
    ...
    dp = function (w, F, X) {
      return arguments.length <= 2
        ? Array.prototype.slice.call(w, F)
        : Array.prototype.slice.call(w, F, X)
    },
    Es = function (w, F) {
      return w === F
    },
  ...
  var Kq = function (w) {
    ...
    ss = function (w) {
      if (w.length <= 8192) return String.fromCharCode.apply(null, w)
    ...
    kg = function (w) {
      for (var F = [], X = 0; X < w.length; X += 2) {
        F.push(parseInt(w.substring(X, X + 2), 16))
      }
      return F
    },
    hj = function (w) {
      for (var F = [], X = 0, c = 0; c < w.length; c++) {
        ...
        g < 128
          ...
          : (g < 2048
            ...
            : ((g & 64512) == 55296 &&
                c + 1 < w.length &&
                (w.charCodeAt(c + 1) & 64512) == 56320
              ? ((g =
                      65536 + ((g & 1023) << 10) + (w.charCodeAt(++c) & 1023)),
              (F[X++] = (g >> 18) | 240),
              (F[X++] = ((g >> 12) & 63) | 128))
              : (F[X++] = (g >> 12) | 224),
            (F[X++] = ((g >> 6) & 63) | 128)),
    ...
    Vz = function (w) {
      for (var F = [], X = 0, c = 0; X < w.length;) {
        var g = w[X++]
        if (g < 128) F[c++] = String.fromCharCode(g)
        else if (g > 191 && g < 224) {
          var Y = w[X++]
  ...
  var eS = function (w, F) {
    ...
    Lq = function (w) {
      ...
      w.indexOf('&') != -1 && (w = w.replace(mR, '&amp;'))
      w.indexOf('<') != -1 && (w = w.replace(Bj, '&lt;'))
      w.indexOf('>') != -1 && (w = w.replace(xg, '&gt;'))
      w.indexOf('"') != -1 && (w = w.replace(Qz, '&quot;'))
      w.indexOf("'") != -1 && (w = w.replace(rp, '&#39;'))
      w.indexOf('\x00') != -1 && (w = w.replace(fq, '&#0;'))
      return w
    },
    mR = /&/g,
    Bj = /</g,
    ...
    nq = function () {
      return (
        ...
        Math.abs(Math.floor(2147483648 * Math.random()) ^ e()).toString(36)
      )
    },
    Gc = function (w, F) {
      for (
        ...
        do {
          p = /(\d*)(\D*)(.*)/.exec(p) || ['', '', '', '']
          T = /(\d*)(\D*)(.*)/.exec(T) || ['', '', '', '']
          if (p[0].length == 0 && T[0].length == 0) break
          X =
            ui(
              p[1].length == 0 ? 0 : parseInt(p[1], 10),
              T[1].length == 0 ? 0 : parseInt(T[1], 10)
            ) ||
            ui(p[2].length == 0, T[2].length == 0) ||
            ui(p[2], T[2])
          p = p[3]
          T = T[3]
        } while (X == 0)
  ...
  var RI = function (w, F, X) {
    ...
    bi = function (w, F) {
      return w !== null && F in w ? w[F] : void 0
    },
    SS = function (w) {
      var F = {},
        X
    ...
    li = function (w, F) {
      for (var X, c, g = 1; g < arguments.length; g++) {
        c = arguments[g]
        for (X in c) w[X] = c[X]
        for (var Y = 0; Y < Wj.length; Y++) {
          ;(X = Wj[Y]),
          Object.prototype.hasOwnProperty.call(c, X) && (w[X] = c[X])
        }
      }
    },
    qR = function (w) {
      var F = arguments.length
      if (F == 1 && k(arguments[0])) return qR.apply(null, arguments[0])
  ...
  var ym = m('Opera'),
    ...
    pU =
      m('Gecko') &&
      !(tj.toLowerCase().indexOf('webkit') != -1 && !m('Edge')) &&
      !(m('Trident') || m('MSIE')) &&
      !m('Edge'),
    T$ = tj.toLowerCase().indexOf('webkit') != -1 && !m('Edge'),
    z$ = T$ && m('Mobile'),
    df = m('Macintosh'),
    jR = m('Windows'),
    E9 = m('Android'),
  ...
  mp =
    Be && x
      ? kG() || (Be.compatMode == 'CSS1Compat' ? parseInt(O9, 10) : 5)
      : void 0
  var xG = m('Firefox'),
    Qm = FB() || m('iPod'),
    rf = m('iPad'),
    fU = m('Android') && !(wf() || m('Firefox') || m('Opera') || m('Silk')),
    LU = wf(),
    He =
      m('Safari') &&
      !(
    ...
    tk = function (w, F) {
      function X (F) {
        for (; c < w.length;) {
          ...
          if (g != null) return g
          if (!/^[\s\xa0]*$/.test(X)) {
            throw Error('Unknown base64 encoding at char: ' + X)
          }
        }
        return F
      }
      ...
      for (var c = 0; ;) {
        ...
        F((g << 2) | (Y >> 4))
        y != 64 &&
          (F(((Y << 4) & 240) | (y >> 2)), p != 64 && F(((y << 6) & 192) | p))
      }
    },
    ZM = function () {
      if (!nU) {
  ...
  var Q = a(),
    ...
    Jk = function (w, F, X) {
      for (var c = [], g = 0; g < w.length; g++) c[g] = F.call(w[g], X, w[g])
      return c
    },
    L = function (w, F) {
      if (F < w.K) {
    ...
    o1 = function (w, F, X) {
      w.R || (w.R = {})
      if (!w.R[X]) {
        for (var c = $G(w, X), g = [], Y = 0; Y < c.length; Y++) {
          g[Y] = new F(c[Y])
        }
        w.R[X] = g
      }
    ...
    bj = function (w) {
      if (w.R) {
        for (var F in w.R) {
          var X = w.R[F]
          if (k(X)) for (var c = 0; c < X.length; c++) X[c] && Nf(X[c])
          else X && Nf(X)
        }
      }
    },
  ...
  var SR = function (w, F) {
      return f7(F) && (isNaN(F) || Infinity === F || -Infinity === F)
        ? String(F)
        : F
    },
    lj = function (w) {
  ...
  var qf
  var wD = !x || Number(mp) >= 9,
    FP = (!pU && !x) || (x && Number(mp) >= 9) || (pU && Pe('1.9.1')),
    XP = x && !Pe('9'),
    c7 = x || ym || T$
  var gD = function (w) {
      return function () {
  ...
  var zz = function (w) {
      return w instanceof Tz && w.constructor === Tz && w.A === pG
        ? w.R
        : 'type_error:Const'
    },
    pG = {},
    ...
    ur = function (w, F) {
      ...
      if (HW === null) {
        a: {
          var X = d.document
          if (
            (X = X.querySelector && X.querySelector('script[nonce]')) &&
            (X = X.nonce || X.getAttribute('nonce')) &&
            L7.test(X)
          ) {
            break a
          }
  ...
  var UW = function (w) {
    ...
    XS = function (w, F) {
      var X = F || document
      return X.querySelectorAll && X.querySelector
        ? X.querySelectorAll('.' + w)
        : JQ(document, '*', w, F)
    },
    G = function (w, F) {
      var X = F || document
      if (X.getElementsByClassName) X = X.getElementsByClassName(w)[0]
      else {
        X = document
        var c = F || X
        X =
          c.querySelectorAll && c.querySelector && w
            ? c.querySelector(w ? '.' + w : '')
            : JQ(X, '*', w, F)[0] || null
      }
      return X || null
    ...
    JQ = function (w, F, X, c) {
      ...
      if (w.querySelectorAll && w.querySelector && (F || X)) {
        return w.querySelectorAll(F + (X ? '.' + X : ''))
      }
      if (X && w.getElementsByClassName) {
        w = w.getElementsByClassName(X)
        if (F) {
          c = {}
          for (var g = 0, Y = 0, y; (y = w[Y]); Y++) {
            F == y.nodeName && (c[g++] = y)
          }
          c.length = g
          return c
        ...
        c == 'style'
          ...
          : c == 'class'
            ...
            : c == 'for'
              ? (w.htmlFor = F)
              : $O.hasOwnProperty(c)
                ? w.setAttribute($O[c], F)
                : c.lastIndexOf('aria-', 0) == 0 ||
                  c.lastIndexOf('data-', 0) == 0
                  ? w.setAttribute(c, F)
                  : (w[c] = F)
      })
    },
    ...
    SZ = function (w) {
      var F = w.scrollingElement
        ? w.scrollingElement
        : !T$ && NX(w) ? w.documentElement : w.body || w.documentElement
      w = w.parentWindow || w.defaultView
      return x && Pe('10') && w.pageYOffset != F.scrollTop
        ? new Gz(F.scrollLeft, F.scrollTop)
        : new Gz(w.pageXOffset || F.scrollLeft, w.pageYOffset || F.scrollTop)
    },
    Z = function (w) {
      return w ? w.parentWindow || w.defaultView : window
    },
    lr = function (w, F, X) {
      return W7(document, arguments)
    },
    W7 = function (w, F) {
      var X = String(F[0]),
        c = F[1]
    ...
    qX = function (w, F, X) {
      ...
      for (var g = 2; g < X.length; g++) {
        var Y = X[g]
        !ZI(Y) || (V(Y) && Y.nodeType > 0) ? c(Y) : P(w_(Y) ? Tc(Y) : Y, c)
      }
    },
    Fm = function (w, F) {
    ...
    Yf = function (w) {
      return FP && void 0 != w.children
        ? w.children
        : lF(w.childNodes, function (w) {
          return w.nodeType == 1
        })
    },
    ah = function (w) {
    ...
    Dq = function (w) {
      return E(w.lastElementChild) ? w.lastElementChild : yt(w.lastChild, !1)
    },
    yt = function (w, F) {
      for (; w && w.nodeType != 1;) w = F ? w.nextSibling : w.previousSibling
      return w
    },
    pS = function (w) {
      var F
      ...
      F = w.parentNode
      return V(F) && F.nodeType == 1 ? F : null
    },
    Tu = function (w, F) {
      if (!w || !F) return !1
      if (w.contains && F.nodeType == 1) return w == F || w.contains(F)
      if (typeof w.compareDocumentPosition !== 'undefined') {
        return w == F || !!(w.compareDocumentPosition(F) & 16)
      }
      for (; F && w != F;) F = F.parentNode
      return F == w
    },
    ir = function (w) {
      return w.nodeType == 9 ? w : w.ownerDocument || w.document
    },
    zu = function (w, F) {
      if ('textContent' in w) w.textContent = F
      else if (w.nodeType == 3) w.data = String(F)
      else if (w.firstChild && w.firstChild.nodeType == 3) {
    ...
    d_ = function (w, F, X, c) {
      if (w != null) {
        for (w = w.firstChild; w;) {
          if ((F(w) && (X.push(w), c)) || d_(w, F, X, c)) return !0
          w = w.nextSibling
        }
      }
      return !1
    },
    EP = { SCRIPT: 1, STYLE: 1, HEAD: 1, IFRAME: 1, OBJECT: 1 },
    Ih = { IMG: ' ', BR: '\n' },
    KS = function (w, F) {
    ...
    sP = function (w) {
      return x && !Pe('9')
        ? ((w = w.getAttributeNode('tabindex')), w != null && w.specified)
        : w.hasAttribute('tabindex')
    },
    Ab = function (w) {
      w = w.tabIndex
      return f7(w) && w >= 0 && w < 32768
    },
    hb = function (w) {
      if (XP && w !== null && 'innerText' in w) {
        w = w.innerText.replace(/(\r\n|\r|\n)/g, '\n')
      } else {
        var F = []
        kf(w, F, !0)
        w = F.join('')
    ...
    kf = function (w, F, X) {
      if (!(w.nodeName in EP)) {
        if (w.nodeType == 3) {
          X
            ? F.push(String(w.nodeValue).replace(/(\r\n|\r|\n)/g, ''))
            : F.push(w.nodeValue)
        } else if (w.nodeName in Ih) F.push(Ih[w.nodeName])
        else for (w = w.firstChild; w;) kf(w, F, X), (w = w.nextSibling)
      }
    },
    w_ = function (w) {
      if (w && typeof w.length === 'number') {
        if (V(w)) {
          return typeof w.item === 'function' || typeof w.item === 'string'
        }
        if (h(w)) return typeof w.item === 'function'
      }
      return !1
    },
    vQ = function (w) {
  ...
  var eF = function (w, F, X) {
    ...
    X === '' || void 0 == X
      ...
      (X = qf),
      F in X ? w.setAttribute(c, X[F]) : w.removeAttribute(c))
      : w.setAttribute(c, X)
  }
  var C = function () {
    this.s8 = this.s8
  ...
  var PQ = function (w, F) {
    var X = M9(OP, F)
    w.s8
      ? E(void 0) ? X.call(void 0) : X()
      : (w.O8 || (w.O8 = []), w.O8.push(E(void 0) ? v(X, void 0) : X))
  }
  C.prototype.O = function () {
    if (this.O8) for (; this.O8.length;) this.O8.shift()()
  }
  var OP = function (w) {
    w && typeof w.b_ === 'function' && w.b_()
  }
  var mc = [],
    BQ = [],
    xf = !1,
  ...
  var tb = function (w, F) {
    ...
    this.Y8 = null
    if (w) {
      var X = (this.type = w.type),
        c = w.changedTouches ? w.changedTouches[0] : null
      ...
      this.pointerType = I(w.pointerType)
        ? w.pointerType
        : CS[w.pointerType] || ''
      this.Y8 = w
  ...
  O(tb, u4)
  var i4 = [1, 4, 2],
    CS = { 2: 'touch', 3: 'pen', 4: 'mouse' },
    UP = function (w) {
      return fS
        ? w.Y8.button == 0
        : w.type == 'click' ? !0 : !!(w.Y8.button & i4[0])
    }
  tb.prototype.A = function () {
    tb.$.A.call(this)
    this.Y8.stopPropagation
      ? this.Y8.stopPropagation()
      : (this.Y8.cancelBubble = !0)
  }
  tb.prototype.preventDefault = function () {
    tb.$.preventDefault.call(this)
    var w = this.Y8
    if (w.preventDefault) w.preventDefault()
    else if (((w.returnValue = !1), HQ)) {
      try {
        if (w.ctrlKey || (w.keyCode >= 112 && w.keyCode <= 123)) w.keyCode = -1
      } catch (F) {}
    }
  }
  var Rh = 'closure_listenable_' + ((1e6 * Math.random()) | 0),
    MA = function (w) {
      return !(!w || !w[Rh])
    },
    Jb = 0
  ...
  NA.prototype.add = function (w, F, X, c, g) {
    ...
    y > -1
      ? ((F = w[y]), X || (F.gd = !1))
      : ((F = new $f(F, this.src, Y, !!c, g)), (F.gd = X), w.push(F))
    return F
  }
  var SF = function (w, F) {
      var X = F.type
      X in w.R &&
        Dc(w.R[X], F) &&
        (oh(F), w.R[X].length == 0 && (delete w.R[X], w.A--))
    },
    ...
    l4 = function (w, F) {
      ...
      return MR(w.R, function (w) {
        for (var F = 0; F < w.length; ++F) {
          if (!((X && w[F].type != c) || (g && void 0 != w[F].capture))) {
            return !0
          }
        }
        return !1
  ...
  var qA = 'closure_lm_' + ((1e6 * Math.random()) | 0),
    ...
    Ye = function (w, F, X, c, g, Y) {
      ...
      if (w.addEventListener) {
        nS || (g = y),
        void 0 === g && (g = !1),
        w.addEventListener(F.toString(), c, g)
      } else if (w.attachEvent) w.attachEvent(DH(F.toString()), c)
      else if (w.addListener && w.removeListener) w.addListener(c)
    ...
    XR = function (w, F, X, c, g) {
      ...
      X = gA(X)
      return MA(w)
        ? w.L.add(String(F), X, !0, V(c) ? !!c.capture : !!c, g)
        : Ye(w, F, X, !0, c, g)
    },
    T7 = function (w, F, X, c, g) {
      if (k(F)) for (var Y = 0; Y < F.length; Y++) T7(w, F[Y], X, c, g)
      else {
        ;(c = V(c) ? !!c.capture : !!c),
        (X = gA(X)),
        MA(w)
          ...
          F in w.R &&
                ...
                X > -1 &&
                  (oh(Y[X]),
                  Array.prototype.splice.call(Y, X, 1),
                  Y.length == 0 && (delete w.R[F], w.A--))))
          : w && (w = yQ(w)) && (X = WQ(w, F, X, c, g)) && z7(X)
      }
    },
    z7 = function (w) {
      if (!f7(w) && w && !w.$y) {
        ...
        if (MA(F)) SF(F.L, w)
          ...
          F.removeEventListener
            ? F.removeEventListener(X, c, w.capture)
            : F.detachEvent
              ? F.detachEvent(DH(X), c)
              : F.addListener && F.removeListener && F.removeListener(c)
          FR--
          ;(X = yQ(F))
            ? (SF(X, w), X.A == 0 && ((X.src = null), (F[qA] = null)))
            : oh(w)
        }
      }
    },
    ...
    E2 = function (w, F, X, c) {
      ...
      if ((w = yQ(w))) {
        if ((F = w.R[F.toString()])) {
          for (F = F.concat(), w = 0; w < F.length; w++) {
            var Y = F[w]
            Y &&
              Y.capture == X &&
              !Y.$y &&
    ...
    pA = function (w, F) {
      if (w.$y) return !0
      if (!LS) {
        var X = F || n7('window.event'),
          c = new tb(X, this),
          g = !0
        if (!(X.keyCode < 0 || void 0 != X.returnValue)) {
          a: {
            var Y = !1
            if (X.keyCode == 0) {
              try {
          ...
          Y = w.type
          for (var y = X.length - 1; !c.J && y >= 0; y--) {
            c.R = X[y]
            var p = E2(X[y], Y, !0, c)
            g = g && p
          }
          for (y = 0; !c.J && y < X.length; y++) {
            ;(c.R = X[y]), (p = E2(X[y], Y, !1, c)), (g = g && p)
          }
        }
        return g
      }
    ...
    I4 = '__closure_events_fn_' + ((1e9 * Math.random()) >>> 0),
    gA = function (w) {
      if (h(w)) return w
      w[I4] ||
        (w[I4] = function (F) {
  ...
  z.dispatchEvent = function (w) {
    ...
    c = w.type || w
    if (I(w)) w = new u4(w, F)
    else if (w instanceof u4) w.target = w.target || F
    else {
      var g = w
      w = new u4(c, F)
      li(w, g)
    ...
    g = !0
    if (X) {
      for (var Y = X.length - 1; !w.J && Y >= 0; Y--) {
        var y = (w.R = X[Y])
        g = s2(y, c, !0, w) && g
      }
    }
    w.J ||
      ...
      w.J || (g = s2(y, c, !1, w) && g))
    if (X) {
      for (Y = 0; !w.J && Y < X.length; Y++) {
        ;(y = w.R = X[Y]), (g = s2(y, c, !1, w) && g)
      }
    }
    return g
  }
  ...
  var h0 = function (w) {
    ...
    ee = function () {
      ...
      if (typeof w !== 'undefined' && !m('Trident') && !m('MSIE')) {
        var F = new w(),
          X = {},
          c = X
  ...
  var qW = function (w, F) {
      if (w.R == 0) {
        if (w.J) {
          ...
          if (X.A) {
            for (
              var c = 0, g = null, Y = null, y = X.A;
              y && (y.D || (c++, y.R == w && (g = y), !(g && c > 1)));
              y = y.next
            ) {
              g || (Y = y)
            }
  ...
  var ZH = function (w, F, X) {
      w.R == 0 &&
        (w === X &&
          ((F = 3), (X = new TypeError('Promise cannot resolve to itself'))),
        (w.R = 1),
        J0(X, w.L, w.s8, w) ||
          ((w.l = X),
          (w.R = F),
  ...
  var FZ = function (w, F, X, c) {
      if (X == 3 && F.A && !F.D) for (; w && w.D; w = w.J) w.D = !1
      if (F.R) (F.R.J = null), yy(F, X, c)
      else {
        try {
    ...
    yy = function (w, F, X) {
      F == 2 ? w.K.call(w.J, X) : w.A && w.A.call(w.J, X)
    },
    g$ = function (w, F) {
      w.D = !0
      Hu(function () {
  ...
  var t = function (w, F, X) {
    if (h(w)) X && (w = v(w, X))
    else if (w && typeof w.handleEvent === 'function') w = v(w.handleEvent, w)
    else throw Error('Invalid listener argument')
    return Number(F) > 2147483647 ? -1 : d.setTimeout(w, F || 0)
  }
  ...
  z.stop = function () {
    this.VV != 0 && d.clearTimeout(this.VV)
    this.VV = 0
  }
  z.Y7 = function () {
    this.VV = 0
  ...
  var TG = function (w, F, X) {
    ...
    for (X = 0; X < this.A; X++) {
      ;(F = X < w.length ? w[X] : 0), (this.Y[X] = F ^ 92), (this.D[X] = F ^ 54)
    }
    this.R.J(this.D)
  }
  O(TG, pw)
  ...
  var I6 = function (w) {
    for (var F = w.Y, X = w.s8, c = 0, g = 0; g < F.length;) {
      ;(X[c++] = (F[g] << 24) | (F[g + 1] << 16) | (F[g + 2] << 8) | F[g + 3]),
      (g = 4 * c)
    }
    for (F = 16; F < 64; F++) {
      g = X[F - 15] | 0
  ...
  jI.prototype.J = function (w, F) {
    ...
    if (I(w)) {
      for (; X < F;) {
        ;(this.Y[c++] = w.charCodeAt(X++)), c == this.A && (I6(this), (c = 0))
      }
    } else if (ZI(w)) {
      for (; X < F;) {
        var g = w[X++]
        if (!(typeof g === 'number' && g >= 0 && g <= 255 && g == (g | 0))) {
  ...
  jI.prototype.K = function () {
    var w = [],
      F = 8 * this.l
    this.D < 56 ? this.J(Ex, 56 - this.D) : this.J(Ex, this.A - (this.D - 56))
    for (var X = 63; X >= 56; X--) (this.Y[X] = F & 255), (F /= 256)
    I6(this)
    for (X = F = 0; X < this.L; X++) {
      for (var c = 24; c >= 0; c -= 8) w[F++] = (this.R[X] >> c) & 255
    }
    return w
  }
  var d$ = [
  ...
  var hF = function (w) {
      ...
      if (typeof w.pK === 'function') return w.pK(!1)
      if (ZI(w)) {
        var F = 0,
          X = new km()
        X.next = function () {
  ...
  var vD = function (w, F) {
    ...
    if (X > 1) {
      ...
      if (w instanceof vD) {
        for (X = w.l_(), c = 0; c < X.length; c++) this.set(X[c], w.get(X[c]))
      } else for (c in w) this.set(c, w[c])
    }
  }
  ...
  var Ox = function (w) {
    ...
    m1 = function (w, F) {
      return PD(w.A, F)
        ? (delete w.A[F], w.J--, w.K++, w.R.length > 2 * w.J && eI(w), !0)
        : !1
    },
    eI = function (w) {
      if (w.J != w.R.length) {
      ...
      if (w.J != w.R.length) {
        var g = {}
        for (X = F = 0; F < w.R.length;) {
          ;(c = w.R[F]), PD(g, c) || ((w.R[X++] = c), (g[c] = 1)), F++
        }
        w.R.length = X
      }
    }
  ...
  var Qy = function (w) {
    if (V(w)) {
      if (h(w.b_)) w.b_()
      else for (var F in w) delete w[F]
    }
  }
  ...
  var HD = a(),
    Cw = function (w, F, X, c) {
      var g = []
      X == -1 ? g.push('    ') : g.push(GG(w.A - X))
      g.push(' ', Zd(w.A - F))
      w.R == 0
        ? g.push(' Start        ')
        : w.R == 1
          ? (g.push(' Done '), g.push(GG(w.D - w.startTime), ' ms '))
          : g.push(' Comment      ')
      g.push(c, w)
      w.K > 0 && g.push('[VarAlloc ', w.K, '] ')
      return g.join('')
    }
  HD.prototype.toString = function () {
    return this.type == null ? this.J : '[' + this.type + '] ' + this.J
  }
  var tF = { Jz: !0 },
    iM = function (w) {
      w.L.stop &&
  ...
  uM.prototype.reset = function () {
    ...
    for (var w = 0; w < this.R.length; w++) {
      var F = this.R[w]
      F.id
        ? PD(this.A.A, F.id) || (r$(this.l, F.id), r$(this.K, F))
        : r$(this.K, F)
    }
    this.R.length = 0
    this.Y = e()
  ...
  uM.prototype.toString = function () {
    ...
    for (c = 0; c < F.length; c++) {
      ;(X = this.J.get(F[c])), X.count > 1 && w.push(' TOTAL ', X, '\n')
    }
    w.push(
  ...
  var GG = function (w) {
    ...
    Zd = function (w) {
      w = Math.round(w)
      return (
        String(100 + (w / 1e3) % 60).substring(1, 3) +
        '.' +
        String(1e3 + w % 1e3).substring(1, 4)
      )
    }
  new uM()
  var Ux = function (w) {
  ...
  var $m = function (w) {
    bF.call(
      ...
      'Error in protected function: ' +
        (w && w.message ? String(w.message) : String(w))
    )
  ...
  var lM = function (w, F, X) {
      if (F == null) X.push('null')
          ...
          if (
            ...
            for (c in F) {
              Object.prototype.hasOwnProperty.call(F, c) &&
                ((Y = F[c]),
                typeof Y !== 'function' &&
                  (X.push(g), qd(c, X), X.push(':'), lM(w, Y, X), (g = ',')))
            }
            X.push('}')
            return
          }
        ...
        switch (typeof F) {
          case 'string':
            ...
            break
          case 'number':
            X.push(isFinite(F) && !isNaN(F) ? String(F) : 'null')
            break
          case 'boolean':
            X.push(String(F))
            break
    ...
    qd = function (w, F) {
      F.push(
        '"',
        w.replace(F1, function (w) {
          var F = ws[w]
          F ||
            ((F = '\\u' + (w.charCodeAt(0) | 65536).toString(16).substr(1)),
            (ws[w] = F))
          return F
        }),
        '"'
  ...
  YS = new yY()
  var Da = function (w) {
      if (w.Tl && typeof w.Tl === 'function') return w.Tl()
    ...
    pB = function (w, F, X) {
      if (w.forEach && typeof w.forEach === 'function') w.forEach(F, X)
      else if (ZI(w) || I(w)) P(w, F, X)
      else {
        if (w.l_ && typeof w.l_ === 'function') var c = w.l_()
        else if (w.Tl && typeof w.Tl === 'function') c = void 0
        else if (ZI(w) || I(w)) {
          c = []
        ...
        g = Da(w)
        Y = g.length
        for (var y = 0; y < Y; y++) F.call(X, g[y], c && c[y], w)
      }
    }
  var T3 = /^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/,
    z3 = function (w) {
      ...
      !w &&
        d.self &&
        d.self.location &&
        ((w = d.self.location.protocol), (w = w.substr(0, w.length - 1)))
      return w ? w.toLowerCase() : ''
    },
    ds = function (w, F) {
      if (w) {
        for (var X = w.split('&'), c = 0; c < X.length; c++) {
          var g = X[c].indexOf('='),
            Y = null
          if (g >= 0) {
    ...
    ER = function (w, F, X) {
      if (k(F)) for (var c = 0; c < F.length; c++) ER(w, String(F[c]), X)
      else {
        F != null &&
          X.push(w + (F === '' ? '' : '=' + encodeURIComponent(String(F))))
      }
    },
    I5 = function (w, F) {
    ...
    KB = function (w) {
      var F = [],
        X
      for (X in w) ER(X, w[X], F)
      return F.join('&')
    },
    sR = function (w, F) {
      var X = arguments.length == 2 ? I5(arguments[1], 0) : I5(arguments, 1)
      return j7(w, X)
    }
  var AM = function (w) {
    KA.call(this)
  ...
  AM.prototype.send = function (w, F, X, c) {
    ...
    c = Yg(g.l_())
    X = d.FormData && w instanceof d.FormData
    !yz(hM, F) ||
      c ||
      X ||
    ...
    'withCredentials' in this.W &&
      this.W.withCredentials !== this.Y &&
      (this.W.withCredentials = this.Y)
    try {
      e7(this),
      this.D > 0 &&
          ((this.VJ = OR(this.W))
            ? ((this.W.timeout = this.D), (this.W.ontimeout = v(this.Sv, this)))
            : (this.o = t(this.Sv, this.D, this))),
      (this.l = !0),
      this.W.send(w),
      (this.l = !1)
    } catch (Y) {
  ...
  var OR = function (w) {
    ...
    gp = function (w) {
      return w.toLowerCase() == 'content-type'
    }
  AM.prototype.Sv = function () {
    typeof rk !== 'undefined' &&
      this.W &&
      ((this.T = 'Timed out after ' + this.D + 'ms, aborting'),
      (this.J = 8),
  ...
  AM.prototype.O = function () {
    this.W &&
      (this.R && ((this.R = !1), (this.A = !0), this.W.abort(), (this.A = !1)),
      mM(this, !0))
    AM.$.O.call(this)
  }
  ...
  var Ba = function (w) {
      if (
        ...
        if (w.l && xS(w) == 4) t(w.Fq, 0, w)
        else if ((w.dispatchEvent('readystatechange'), xS(w) == 4)) {
          w.R = !1
          try {
            if (rs(w)) w.dispatchEvent('complete'), w.dispatchEvent('success')
            else {
              w.J = 6
              try {
                var F = xS(w) > 2 ? w.W.statusText : ''
              } catch (X) {
                F = ''
              }
              w.T = F + ' [' + QY(w) + ']'
    ...
    rs = function (w) {
      ...
      if (!X) {
        if ((F = F === 0)) (w = z3(String(w.HU))), (F = !kS.test(w))
        X = F
      }
      return X
    },
  ...
  var LB = function (w, F, X) {
    ...
    this.D = w
    if (!X) {
      if (((this.R = null), x && !Pe('10'))) r_(v(this.K, this))
      else {
  ...
  LB.prototype.K = function (w, F) {
    ...
    if (I(w)) {
      ...
      try {
        var y =
          w.fileName || w.filename || w.sourceURL || d.$googDebugFname || c
      } catch (r) {
        ;(y = 'Not available'), (g = !0)
      }
      c =
        !g && w.lineNumber && w.fileName && w.stack && w.message && w.name
          ? w
          : {
  ...
  var u1 = function (w) {
    ...
    Za = function (w, F) {
      w.classList
        ? w.classList.add(F)
        : G3(w, F) || (w.className += w.className.length > 0 ? ' ' + F : F)
    },
    CB = function (w, F) {
      if (w.classList) {
        P(F, function (F) {
        ...
        w.className = ''
        for (var c in X) w.className += w.className.length > 0 ? ' ' + c : c
      }
    },
    tM = function (w, F) {
      w.classList
  ...
  var R5 = function (w, F) {
    if (w.tagName == 'FORM') {
      for (var X = w.elements, c = 0; (w = X[c]); c++) R5(w, F)
    } else F == 1 && w.blur(), (w.disabled = F)
  }
  var $S = function (w, F, X, c, g, Y) {
      ...
      if (!pU) {
        f7(F) && (F = JM(F))
        var y = F == 17 || F == 18 || (df && F == 91)
        if (((!X || df) && y) || (df && F == 16 && (c || Y))) return !1
      }
      if ((T$ || a1) && c && X) {
        switch (w) {
          case 220:
  ...
  NP.prototype.J = function (w) {
    ;(w.keyCode == 13 || (T$ && w.keyCode == 3)) && b1(this, w)
  }
  ...
  var F0 = function (w, F, X, c) {
    ...
    wi = function (w, F, X, c, g, Y) {
      if (k(X)) for (var y = 0; y < X.length; y++) wi(w, F, X[y], c, g, Y)
      else {
        ;(F = XR(F, X, c || w.handleEvent, g, Y || w.l || w)) &&
          (w.D[F.key] = F)
      }
    },
    X0 = function (w, F, X, c, g, Y) {
      if (k(X)) for (var y = 0; y < X.length; y++) X0(w, F, X[y], c, g, Y)
      else {
        ;(c = c || w.handleEvent),
        (g = V(g) ? !!g.capture : !!g),
        (Y = Y || w.l || w),
        ...
        (g = !!g),
        (X = MA(F)
          ? WQ(F.L, String(X), c, g, Y)
          : F ? ((F = yQ(F)) ? WQ(F, X, c, g, Y) : null) : null),
        X && (z7(X), delete w.D[X.key])
      }
      return w
    },
    cP = function (w) {
  ...
  YH.prototype.R = function (w) {
    if (T$ || a1) {
      if (
        (this.tO == 17 && !w.ctrlKey) ||
        (this.tO == 18 && !w.altKey) ||
        (df && this.tO == 91 && !w.metaKey)
      ) {
        this.hO = this.tO = -1
      }
    }
    this.tO == -1 &&
      (w.ctrlKey && w.keyCode != 17
        ? (this.tO = 17)
        : w.altKey && w.keyCode != 18
          ? (this.tO = 18)
          : w.metaKey && w.keyCode != 91 && (this.tO = 91))
    D3 && !$S(w.keyCode, this.tO, w.shiftKey, w.ctrlKey, w.altKey, w.metaKey)
      ? this.handleEvent(w)
      : ((this.hO = JM(w.keyCode)), pk && (this.l2 = w.altKey))
  }
  ...
  YH.prototype.handleEvent = function (w) {
    var F = w.Y8,
      X = F.altKey
    if (x && w.type == 'keypress') {
      var c = this.hO
      var g = c != 13 && c != 27 ? F.keyCode : 0
    } else {
      ;(T$ || a1) && w.type == 'keypress'
        ? ((c = this.hO),
        (g = F.charCode >= 0 && F.charCode < 63232 && MP(c) ? F.charCode : 0))
        : ym && !T$
          ? ((c = this.hO), (g = MP(c) ? F.keyCode : 0))
          : ((c = F.keyCode || this.hO),
          (g = F.charCode || 0),
          pk && w.type == 'keypress' && (X = this.l2),
          df && g == 63 && c == 224 && (c = 191))
    }
    var Y = (c = JM(c))
    c
      ? c >= 63232 && c in yq ? (Y = yq[c]) : c == 25 && w.shiftKey && (Y = 9)
      : F.keyIdentifier && F.keyIdentifier in aA && (Y = aA[F.keyIdentifier])
    ;(pU &&
      D3 &&
      w.type == 'keypress' &&
      !$S(Y, this.tO, w.shiftKey, w.ctrlKey, X, w.metaKey)) ||
      ((w = Y == this.tO),
      (this.tO = Y),
      (F = new TV(Y, g, w, F)),
      (F.altKey = X),
  ...
  kH.prototype.D = function (w) {
    if (w || this.R == 0) (this.progress = 0), (this.coords = this.K)
    else if (this.R == 1) return
    Eh(this)
    this.startTime = w = e()
    this.R == -1 && (this.startTime -= this.duration * this.progress)
    this.endTime = this.startTime + this.duration
    this.G = this.startTime
    this.progress || this.l()
    this.J('play')
    this.R == -1 && this.J('resume')
    this.R = 1
    var F = iF(this)
    F in di || (di[F] = this)
    Kk()
  ...
  kH.prototype.O = function () {
    this.R == 0 || this.stop(!1)
    this.J('destroy')
    kH.$.O.call(this)
  }
  var sh = function (w, F) {
      F < w.startTime &&
        ((w.endTime = F + w.endTime - w.startTime), (w.startTime = F))
      w.progress = (F - w.startTime) / (w.endTime - w.startTime)
      w.progress > 1 && (w.progress = 1)
      w.G = F
      hO(w, w.progress)
      w.progress == 1 ? ((w.R = 0), Eh(w), w.o(), w.Y()) : w.R == 1 && w.A()
    },
    hO = function (w, F) {
      h(w.Z) && (F = w.Z(F))
      w.coords = Array(w.K.length)
      for (var X = 0; X < w.K.length; X++) {
        w.coords[X] = (w.X[X] - w.K[X]) * F + w.K[X]
      }
    }
  ...
  eO.prototype.stop = function (w) {
    ...
    this.endTime = e()
    if (w) {
      for (w = this.K; w < this.A.length; ++w) {
        var F = this.A[w]
        F.R == 0 && F.D()
        F.R == 0 || F.stop(!0)
      }
  ...
  eO.prototype.T = function () {
    this.R == 1 &&
      ...
      this.K < this.A.length
        ? this.A[this.K].D()
        : ((this.endTime = e()), (this.R = 0), this.o(), this.Y()))
  }
  ...
  Oh.prototype.A = function () {
    this.T.style.backgroundPosition =
      -Math.floor(this.coords[0] / this.WU.width) * this.WU.width +
      'px ' +
      -Math.floor(this.coords[1] / this.WU.height) * this.WU.height +
      'px'
    Oh.$.A.call(this)
  }
  ...
  var PP = function (w) {
    ...
    typeof w.backgroundPositionX !== 'undefined' &&
      ((w.backgroundPositionX = ''), (w.backgroundPositionY = ''))
  }
  Oh.prototype.O = function () {
    Oh.$.O.call(this)
    this.T = null
  ...
  var Qq = function (w, F, X) {
    ...
    xH = function (w, F) {
      ...
      if (!X) {
        ...
        void 0 === w.style[c] &&
          ((c =
            (T$ ? 'Webkit' : pU ? 'Moz' : x ? 'ms' : ym ? 'O' : null) + Cq(c)),
          void 0 !== w.style[c] && (X = c))
        ri[F] = X
      }
      return X
    },
    fk = function (w, F) {
      var X = w.style[Zc(F)]
      return typeof X !== 'undefined' ? X : w.style[xH(w, F)] || ''
    },
    Lk = function (w, F) {
      var X = ir(w)
      return X.defaultView &&
        X.defaultView.getComputedStyle &&
        (X = X.defaultView.getComputedStyle(w, null))
        ? X[F] || X.getPropertyValue(F) || ''
        : ''
    },
    HP = function (w, F) {
      return (
        Lk(w, F) ||
        (w.currentStyle ? w.currentStyle[F] : null) ||
        (w.style && w.style[F])
      )
    },
    nk = function (w) {
      ...
      x &&
        ...
        ((w = w.ownerDocument),
        (F.left -= w.documentElement.clientLeft + w.body.clientLeft),
        (F.top -= w.documentElement.clientTop + w.body.clientTop))
      return F
    },
    u9 = function (w) {
      var F = ir(w),
      ...
      c = !x || Number(mp) >= 9 || NX(UW(c).R) ? c.documentElement : c.body
      if (w == c) return X
      w = nk(w)
      F = SZ(UW(F).R)
      X.x = w.left + F.x
    ...
    GV = function (w) {
      if (w.nodeType == 1) return (w = nk(w)), new Gz(w.left, w.top)
      w = w.changedTouches ? w.changedTouches[0] : w
      return new Gz(w.clientX, w.clientY)
    },
    Ck = function (w, F, X) {
      if (F instanceof u) (X = F.height), (F = F.width)
      else if (void 0 == X) throw Error('missing height argument')
      w.style.width = Z3(F)
      w.style.height = Z3(X)
    },
    Z3 = function (w) {
      typeof w === 'number' && (w = Math.round(w) + 'px')
      return w
    },
    i9 = function (w) {
      var F = tO
      if (HP(w, 'display') != 'none') return F(w)
      var X = w.style,
        c = X.display,
        g = X.visibility,
        Y = X.position
    ...
    tO = function (w) {
      var F = w.offsetWidth,
        X = w.offsetHeight,
        c = T$ && !F && !X
      return (E(F) && !c) || !w.getBoundingClientRect
        ? new u(F, X)
        : ((w = nk(w)), new u(w.right - w.left, w.bottom - w.top))
    },
    Uh = function (w) {
      var F = u9(w)
      w = i9(w)
    ...
    oA = function (w) {
      var F = UW(void 0),
        X = F.R
      if (x && X.createStyleSheet) (F = X.createStyleSheet()), $H(F, w)
      else {
    ...
    Ns = pU ? 'MozUserSelect' : T$ || a1 ? 'WebkitUserSelect' : null,
    b9 = function (w, F) {
      if (/^\d+px?$/.test(F)) return parseInt(F, 10)
      var X = w.style.left,
        c = w.runtimeStyle.left
    ...
    l9 = /[^\d]+$/,
    qs = { cm: 1, in: 1, mm: 1, pc: 1, pt: 1 },
    w8 = { em: 1, ex: 1 },
    FA = function (w) {
      var F = HP(w, 'fontSize')
      var X = ((X = F.match(l9)) && X[0]) || null
      if (F && X == 'px') return parseInt(F, 10)
      if (x) {
        if (String(X) in qs) return b9(w, F)
        if (w.parentNode && w.parentNode.nodeType == 1 && String(X) in w8) {
          return (
            (w = w.parentNode),
            (X = HP(w, 'fontSize')),
            b9(w, F == X ? '1em' : F)
  ...
  var XA = (function () {
    ...
    return df
      ? ((w = /10[_.][0-9_.]+/),
      (w = w.exec(tj)) ? w[0].replace(/_/g, '.') : '10')
      : E9
        ? ((w = /Android\s+([^\);]+)(\)|;)/), (w = w.exec(tj)) ? w[1] : '')
        : I1 || KU || s9
          ? ((w = /(?:iPhone|CPU)\s+OS\s+(\S+)/),
          (w = w.exec(tj)) ? w[1].replace(/_/g, '.') : '')
          : ''
  })()
  var cS = function (w) {
    ...
    g8 = (function () {
      ...
      if (Qm || rf) {
        ...
        return (w = cS(/Android\s+([0-9.]+)/)) ? w : cS(/Version\/([0-9.]+)/)
      }
      return ''
    })()
  ...
  var zg = function (w, F, X, c) {
    ...
    d8 = function (w, F, X) {
      ...
      var c = w.R,
        ...
        y = w.K - w.J
      return (
        ((Number(F) - c) * (w.A - c) + (Number(X) - g) * (w.K - g)) /
        (Y * Y + y * y)
      )
    },
    jg = function (w, F) {
...
*/
  ...
  En.prototype.cancel = function (w) {
    if (this.R) this.J instanceof En && this.J.cancel()
    else {
      if (this.A) {
        var F = this.A
        delete this.A
        w ? F.cancel(w) : (F.T--, F.T <= 0 && F.cancel())
      }
  ...
  var VN = function (w) {
    ...
    AU = function (w) {
      ...
      for (var c = (X = !1); w.D.length && !w.l;) {
        ...
        if ((Y = w.K ? y : Y)) {
          try {
            ...
            E(p) &&
              ((w.K = w.K && (p == F || p instanceof Error)), (w.J = F = p))
            if (
              G7(F) ||
              (typeof d.Promise === 'function' && F instanceof d.Promise)
            ) {
              ;(c = !0), (w.l = !0)
            }
          } catch (T) {
      ...
      c &&
        ((p = v(w.s8, w, !0)),
        (c = v(w.s8, w, !1)),
        F instanceof En ? (hU(F, p, c), (F.O8 = !0)) : F.then(p, c))
  ...
  var xn = function (w) {
      var F = {},
        X = F.document || document,
        c = EW(w),
        g = Fm(document, 'SCRIPT'),
        Y = { A6: g, Sv: void 0 },
        y = new En(On, Y),
        p = null,
        T = F.timeout != null ? F.timeout : 5e3
      T > 0 &&
      ...
      g.onload = g.onreadystatechange = function () {
        ;(g.readyState &&
          ...
          (PS(g, F.qX || !1, p), KJ(y), sn(y, !0, null))
      }
      g.onerror = function () {
        PS(g, !0, p)
        var w = new mz(0, 'Error while loading script ' + c)
        KJ(y)
        sn(y, !1, w)
      }
      Y = F.attributes || {}
    ...
    BS = function (w) {
      var F = MX('HEAD', w)
      return F && F.length != 0 ? F[0] : w.documentElement
    },
    On = function () {
      if (this && this.A6) {
        var w = this.A6
        w && w.tagName == 'SCRIPT' && PS(w, !0, this.Sv)
      }
    },
    PS = function (w, F, X) {
      X != null && d.clearTimeout(X)
      w.onload = A
      w.onerror = A
  ...
  var QN = function () {
    ...
    r8 = function (w) {
      w.A.length == 0 && ((w.A = w.R), w.A.reverse(), (w.R = []))
      return w.A.pop()
    },
    fJ = function (w) {
  ...
  QN.prototype.Tl = function () {
    for (var w = [], F = this.A.length - 1; F >= 0; --F) w.push(this.A[F])
    var X = this.R.length
  ...
  nJ.prototype.i2 = function () {
    var w = e()
    if (!(this.Y != null && w - this.Y < this.delay)) {
      for (var F; fJ(this.R) > 0 && ((F = r8(this.R)), !this.l(F));) this.ky()
  ...
  nJ.prototype.ky = function () {
    ...
    for (; ut(this) > this.J && fJ(this.R) > 0;) Zn(r8(w))
  }
  nJ.prototype.D = function () {
    return {}
  }
  var Zn = function (w) {
    if (typeof w.b_ === 'function') w.b_()
    else for (var F in w) w[F] = null
  }
  nJ.prototype.l = function (w) {
    return typeof w.Da === 'function' ? w.Da() : !0
  }
  var ut = function (w) {
  ...
  nJ.prototype.O = function () {
    nJ.$.O.call(this)
    if (this.A.R.J > 0) throw Error('[goog.structs.Pool] Objects not released')
    delete this.A
    for (var w = this.R; w.A.length != 0 || w.R.length != 0;) Zn(r8(w))
    delete this.R
  }
  var CJ = function (w, F) {
    this.R = w
  ...
  var tU = function (w) {
      ...
      if (w) {
        a: {
          if (w instanceof tU) {
            ...
            w = w.Tl()
            if (this.R.length <= 0) {
              for (var X = this.R, c = 0; c < F.length; c++) {
                X.push(new CJ(F[c], w[c]))
              }
              break a
            }
          } else (F = $g(w)), (w = Jj(w))
    ...
    it = function (w, F, X) {
      ...
      w = w.R
      for (X = w[F]; F > 0;) {
        if (((c = (F - 1) >> 1), w[c].R > X.R)) (w[F] = w[c]), (F = c)
        else break
      }
      w[F] = X
    }
  ...
  JU.prototype.T = function (w, F) {
    ...
    X && !X.UW
      ? (this.J.U(F, $n, X.VH),
      (F.D = Math.max(0, this.D)),
      (F.K = X.yH()),
      (F.Y = X.Wd()),
      (X.UW = F),
      this.dispatchEvent(new NZ('ready', this, w, F)),
      bt(this, w, F),
      X.ta && F.abort())
      : Gg(this.A, F)
  }
  JU.prototype.l = function (w, F) {
    ...
    switch (F.type) {
      ...
      case 'complete':
        a: {
          var c = this.R.get(w)
          if (X.J == 7 || rs(X) || c.PS > c.qZ) {
            if (
              (this.dispatchEvent(new NZ('complete', this, w, X)),
              c && ((c.OP = !0), c.Bd))
            ) {
              X = c.Bd.call(X, F)
              break a
  ...
  var bt = function (w, F, X) {
    var c = w.R.get(F)
    !c || c.OP || c.PS > c.qZ
      ? (c && (X0(w.J, X, $n, c.VH), m1(w.R, F)), Gg(w.A, X))
      : (c.PS++, X.send(c.wx(), c.Ho(), c.U8(), c.t6))
  }
  ...
  var Sg = function (w, F) {
    ...
    w instanceof Sg
      ...
      : w && (X = String(w).match(T3))
        ...
        wj(this, X[6] || '', !0),
        XO(this, X[7] || '', !0))
        : ((this.l = !!F), (this.A = new gj(null, this.l)))
  }
  Sg.prototype.toString = function () {
    ...
    if (X || F == 'file') {
      w.push('//'),
      (F = this.Y) && w.push(Yk(F, yS, !0), '@'),
      w.push(
        encodeURIComponent(String(X)).replace(/%25([0-9a-fA-F]{2})/g, '%$1')
      ),
      (X = this.K),
      X != null && w.push(':', String(X))
    }
    if ((X = this.D)) {
      this.J && X.charAt(0) != '/' && w.push('/'),
      w.push(Yk(X, X.charAt(0) == '/' ? aF : Do, !0))
    }
  ...
  Sg.prototype.resolve = function (w) {
    ...
    X ? WS(F, w.R) : (X = !!w.Y)
    X ? (F.Y = w.Y) : (X = !!w.J)
    X ? (F.J = w.J) : (X = w.K != null)
    var c = w.D
    if (X) lt(F, w.K)
    else if ((X = !!w.D)) {
      if (c.charAt(0) != '/') {
        if (this.J && !this.D) c = '/' + c
        else {
          var g = F.D.lastIndexOf('/')
          g != -1 && (c = F.D.substr(0, g + 1) + c)
        }
      }
      g = c
      if (g == '..' || g == '.') c = ''
        ...
        for (var Y = [], y = 0; y < g.length;) {
          ...
          p == '.'
            ? c && y == g.length && Y.push('')
            : p == '..'
              ? ((Y.length > 1 || (Y.length == 1 && Y[0] != '')) && Y.pop(),
              c && y == g.length && Y.push(''))
              : (Y.push(p), (c = !0))
        }
        c = Y.join('/')
  ...
  var WS = function (w, F, X) {
    ...
    lt = function (w, F) {
      if (F) {
        F = Number(F)
        if (isNaN(F) || F < 0) throw Error('Bad port number ' + F)
        w.K = F
      } else w.K = null
    },
    qZ = function (w, F, X) {
    ...
    c8 = function (w, F) {
      return w
        ? F ? decodeURI(w.replace(/%25/g, '%2525')) : decodeURIComponent(w)
        : ''
    },
    Yk = function (w, F, X) {
      return I(w)
        ? ((w = encodeURI(w).replace(F, IF)),
        X && (w = w.replace(/%25([0-9a-fA-F]{2})/g, '%$1')),
        w)
        : null
    },
    IF = function (w) {
    ...
    KP = function (w) {
      w.R ||
        ...
        w.J &&
          ds(w.J, function (F, X) {
            w.add(decodeURIComponent(F.replace(/\+/g, ' ')), X)
          }))
    }
  ...
  var AD = function (w, F) {
      ...
      F = sZ(w, F)
      PD(w.R.A, F) &&
        ((w.J = null), (w.A = w.A - w.R.get(F).length), m1(w.R, F))
    },
    kk = function (w, F) {
      KP(w)
      F = sZ(w, F)
  ...
  z.l_ = function () {
    KP(this)
    for (
      var w = this.R.Tl(), F = this.R.l_(), X = [], c = 0;
      c < F.length;
      c++
    ) {
      for (var g = w[c], Y = 0; Y < g.length; Y++) X.push(F[c])
    }
    return X
  }
  z.Tl = function (w) {
    KP(this)
    var F = []
    if (I(w)) kk(this, w) && (F = pq(F, this.R.get(sZ(this, w))))
    else {
      w = this.R.Tl()
  ...
  z.get = function (w, F) {
    if (!w) return F
    var X = this.Tl(w)
    return X.length > 0 ? String(X[0]) : F
  }
  var dj = function (w, F, X) {
    AD(w, F)
    X.length > 0 &&
      ((w.J = null), w.R.set(sZ(w, F), Tc(X)), (w.A = w.A + X.length))
  }
  ...
  var rj = function (w, F, X) {
    ...
    LP = function (w) {
      ...
      w = Fm(X, 'DIV')
      x
        ? ((F = fG(LG, F)), nG(w, xO(F)), w.removeChild(w.firstChild))
        : nG(w, xO(F))
      if (w.childNodes.length == 1) X = w.removeChild(w.firstChild)
      else {
        for (X = X.createDocumentFragment(); w.firstChild;) {
    ...
    H8 = function (w, F, X, c) {
      ...
      c.childNodes.length == 1 &&
        ((w = c.firstChild), w.nodeType == 1 && (c = w))
      return c
    },
    xk = function (w) {
  ...
  var uo = function (w, F) {
      ...
      return c.replace(/%([0\- \+]*)(\d+)?(\.(\d+))?([%sfdiu])/g, function (
        w,
        F,
        c,
        p,
    ...
    nP = {
      s: function (w, F, X) {
        return isNaN(X) || X == '' || w.length >= Number(X)
          ? w
          : (w =
              F.indexOf('-', 0) > -1
                ? w + Hj(' ', Number(X) - w.length)
                : Hj(' ', Number(X) - w.length) + w)
      },
      f: function (w, F, X, c, g) {
        ...
        c = isNaN(g)
          ? Math.abs(Number(w)).toString()
          : Math.abs(Number(w)).toFixed(g)
        w = Number(X) - c.length - Y.length
        return (c =
          F.indexOf('-', 0) >= 0
            ? Y + c + Hj(' ', w)
            : Y + Hj(F.indexOf('0', 0) >= 0 ? '0' : ' ', w) + c)
      },
      d: function (w, F, X, c, g, Y, y, p) {
        return nP.f(parseInt(w, 10), F, X, c, 0, Y, y, p)
      }
    }
  nP.i = nP.d
  nP.u = nP.d
  ...
  var JD = function (w, F) {
    ...
    F.JO && w.JO && F.J == w
      ? ((c = w.Pd()),
      (X = c.childNodes[X] || null),
      X != F.V() && c.insertBefore(F.V(), X))
      : w.JO &&
        !F.JO &&
        F.N &&
        F.N.parentNode &&
        F.N.parentNode.nodeType == 1 &&
        F.P()
  }
  U.prototype.Pd = D('N')
  var M7 = function (w, F) {
  ...
  $k.prototype.WS = function (w, F) {
    F.id && UZ(w, F.id)
    F && F.firstChild
      ? q7(w, F.firstChild.nextSibling ? Tc(F.childNodes) : F.firstChild)
      : (w.Tn = null)
    var X = 0,
      c = this.Gl(),
      g = this.Gl(),
    ...
    P(
      ...
      function (w) {
        Y || w != c
          ? y || w != g ? (X |= wg(this, w)) : (y = !0)
          : ((Y = !0), g == c && (y = !0))
        wg(this, w) == 1 && sP(F) && Ab(F) && KS(F, !1)
      },
      this
    )
    w.DR = X
    ...
    if (x && !Pe('7')) {
      var B = W8(T)
      B.length > 0 && (T.push.apply(T, B), (p = !0))
    }
    if (!Y || !y || K || p) F.className = T.join(' ')
    return F
  }
  $k.prototype.dx = function (w) {
    w.wN == null && (w.wN = HP(w.JO ? w.N : w.K.R.body, 'direction') == 'rtl')
    w.wN && this.X1(w.V(), !0)
  ...
  z.XF = function (w, F) {
    var X = !F,
      c = x || ym ? w.getElementsByTagName('*') : null
    if (Ns) {
      if (((X = X ? 'none' : ''), w.style && (w.style[Ns] = X), c)) {
        for (var g = 0, Y; (Y = c[g]); g++) Y.style && (Y.style[Ns] = X)
      }
    } else if (x || ym) {
      if (((X = X ? 'on' : ''), w.setAttribute('unselectable', X), c)) {
        for (g = 0; (Y = c[g]); g++) Y.setAttribute('unselectable', X)
      }
    }
  }
  z.X1 = function (w, F) {
  ...
  z.af = function (w, F, X) {
    ...
    c && ((c = bo[c] || F), (F = F == 'checked' || F == 'selected' ? c : F))
    F && eF(w, F, X)
  }
  var cq = function (w, F) {
    if (w && (cQ(w), F)) {
  ...
  M.prototype.P = function () {
    ...
    this.D.dx(this)
    this.nI & -2 &&
      (this.KY && DT(this, !0), this.nI & 32 && (w = this.V())) &&
      ((F = this.Z || (this.Z = new YH())),
      gi(F, w),
      R(this)
        .U(F, 'key', this.N6)
        .U(w, 'focus', this.un)
  ...
  var DT = function (w, F) {
    ...
    F
      ? (X.U(c, Zq.Ta, w.Yy)
        .U(c, [Zq.Y2, Zq.QH], w.DU)
        .U(c, 'mouseover', w.dN)
        .U(c, 'mouseout', w.kP),
      w.JA != A && X.U(c, 'contextmenu', w.JA),
      x &&
          (Pe(9) || X.U(c, 'dblclick', w.cd),
          w.G || ((w.G = new z1(w)), PQ(w, w.G))))
      : (X0(
        X0(
          X0(X0(X, c, Zq.Ta, w.Yy), c, [Zq.Y2, Zq.QH], w.DU),
          c,
          'mouseover',
          w.dN
        ),
      ...
      w.JA != A && X0(X, c, 'contextmenu', w.JA),
      x && (Pe(9) || X0(X, c, 'dblclick', w.cd), OP(w.G), (w.G = null)))
  }
  ...
  M.prototype.If = function (w) {
    var F = this.J
    ;(F && typeof F.isEnabled === 'function' && !F.isEnabled()) ||
      !jC(this, 1, !w) ||
      (w || (EY(this, !1), I2(this, !1)),
      this.jQ && this.D.FF(this, w),
      K3(this, 1, !w, !0))
  }
  var I2 = function (w, F) {
      jC(w, 2, F) && K3(w, 2, F)
  ...
  var K3 = function (w, F, X, c) {
      c || F != 1
        ? w.nI & F &&
          X != !!(w.DR & F) &&
          (w.D.fY(w, F, X), (w.DR = X ? w.DR | F : w.DR & ~F))
        : w.If(!X)
    },
    sY = function (w, F, X) {
    ...
    jC = function (w, F, X) {
      return (
        !!(w.nI & F) &&
        !!(w.DR & F) != X &&
        (!(0 & F) || w.dispatchEvent(tD(F, X))) &&
        !w.s8
      )
    }
  z = M.prototype
  z.dN = function (w) {
    ;(!w.relatedTarget || !Tu(this.V(), w.relatedTarget)) &&
  ...
  z.kP = function (w) {
    ;(w.relatedTarget && Tu(this.V(), w.relatedTarget)) ||
      ...
      (AN(this, 4) && EY(this, !1), AN(this, 2) && I2(this, !1))
  }
  z.JA = A
  z.Yy = function (w) {
    this.isEnabled() &&
      ...
      !UP(w) ||
        (T$ && df && w.ctrlKey) ||
        (AN(this, 4) && EY(this, !0),
        this.D && this.D.qV(this) && this.V().focus()))
    !UP(w) || (T$ && df && w.ctrlKey) || w.preventDefault()
  }
  z.DU = function (w) {
    this.isEnabled() &&
      (AN(this, 2) && I2(this, !0),
      this.DR & 4 && this.Fu(w) && AN(this, 4) && EY(this, !1))
  }
  z.cd = function (w) {
  ...
  z.N6 = function (w) {
    return this.jQ && this.isEnabled() && this.mk(w)
      ? (w.preventDefault(), w.A(), !0)
      : !1
  }
  z.mk = function (w) {
    return w.keyCode == 13 && this.Fu(w)
  }
  ...
  var z1 = function (w) {
    ...
    PQ(this, this.J)
    w = this.A.N
    this.J.U(w, 'mousedown', this.D)
      .U(w, 'mouseup', this.Y)
      .U(w, 'click', this.K)
  }
  O(z1, C)
  var hN = !x || Number(mp) >= 9
  ...
  eC.prototype.mk = function (w) {
    return (w.keyCode == 13 && w.type == 'key') ||
      (w.keyCode == 32 && w.type == 'keyup')
      ? this.Fu(w)
      : w.keyCode == 32
  }
  ...
  OY.prototype.D = null
  var mD = function () {
    Pq != null || (Pq = 'placeholder' in Fm(document, 'INPUT'))
    return Pq
  }
  z = OY.prototype
  z.HS = !1
  ...
  var f3 = function (w) {
      return w.D != null ? w.D : QC(w) ? w.V().value : ''
    },
    x0 = function (w) {
      var F = w.V()
      ...
      eF(F, 'label', w.R)
      QC(w)
        ? ((F = w.V()), tM(F, 'label-input-label'))
        : (w.T || w.HS || ((F = w.V()), Za(F, 'label-input-label')),
        mD() || t(w.B, 10, w))
    },
    L3 = function (w) {
      var F = QC(w)
  ...
  var n3 = function (w, F) {
    ...
    N = function (w) {
      return w != null && w.qa === hD
        ? w
        : w instanceof B7 ? J(xO(w), w.R()) : J(Lq(String(String(w))), uV(w))
    },
    J = (function (w) {
      function F (w) {
        this.R = w
    ...
    b = function (w, F) {
      return h(w) && h(F)
        ? w.qa !== F.qa ? !1 : w.toString() === F.toString()
        : w instanceof md && F instanceof md
          ? w.qa != F.qa ? !1 : w.toString() == F.toString()
          : w == F
    },
    G1 = function (w) {
    ...
    o2 = function (w) {
      ...
      w instanceof KG
        ...
        : w instanceof jZ
          ? (w = R2(EW(w)))
          : ((w = String(w)),
          (w = Mx.test(w) ? w.replace(JN, $0) : 'about:invalid#zSoyz'))
      return w
    },
    bV = function (w) {
      if (n3(w, VS) || n3(w, v8)) return R2(w)
      w instanceof KG
        ...
        : w instanceof jZ
          ? (w = R2(EW(w)))
          : ((w = String(w)),
          (w = Nx.test(w) ? w.replace(JN, $0) : 'about:invalid#zSoyz'))
      return w
    },
    Wq = function (w) {
      ...
      w == null
        ? (w = '')
        : w instanceof kO
          ? (w instanceof kO && w.constructor === kO && w.A === AQ
            ? (w = w.R)
            : (G0(w), (w = 'type_error:SafeStyle')),
          (w = ZT(w)))
          : w instanceof Vs
            ? (w = ZT(P7(w)))
            : ((w = String(w)), (w = SC.test(w) ? w : 'zSoyz'))
      return w
    },
    lV = {
      '\x00': '&#0;',
  ...
  var FC = function (w) {
    ...
    var F = J,
      X =
        '<span class="' +
        S('recaptcha-checkbox') +
        ' ' +
        S('goog-inline-block') +
        (w.checked
          ? ' ' + S('recaptcha-checkbox-checked')
          : ' ' + S('recaptcha-checkbox-unchecked')) +
        (w.disabled ? ' ' + S('recaptcha-checkbox-disabled') : '') +
        (w.OW ? ' ' + S(w.OW) : '') +
        '" role="checkbox" aria-checked="' +
        (w.checked ? 'true' : 'false') +
        '"' +
        (w.KZ ? ' aria-labelledby="' + S(w.KZ) + '"' : '') +
        (w.id ? ' id="' + S(w.id) + '"' : '') +
        (w.disabled
          ? ' aria-disabled="true" tabindex="-1"'
          : ' tabindex="' + (w.DF ? S(w.DF) : '0') + '"')
    if (w.attributes) {
      var c = w.attributes
      n3(c, e2)
        ? (c = c.U8().replace(/([^"'\s])$/, '$1 '))
        : ((c = String(c)), (c = ww.test(c) ? c : 'zSoyz'))
      c = ' ' + c
    } else c = ''
    X = X + c + ' dir="ltr">'
    w = w = { Ib: w.Ib, tf: w.tf }
    w = J(
      (w.Ib
        ? '<div class="' +
          (w.tf ? S('recaptcha-checkbox-nodatauri') + ' ' : '') +
          S('recaptcha-checkbox-border') +
          '" role="presentation"></div><div class="' +
          (w.tf ? S('recaptcha-checkbox-nodatauri') + ' ' : '') +
          S('recaptcha-checkbox-borderAnimation') +
          '" role="presentation"></div><div class="' +
          (w.tf ? S('recaptcha-checkbox-nodatauri') + ' ' : '') +
          S('recaptcha-checkbox-spinner') +
          '" role="presentation"></div><div class="' +
          (w.tf ? S('recaptcha-checkbox-nodatauri') + ' ' : '') +
          S('recaptcha-checkbox-spinnerAnimation') +
          '" role="presentation"></div>'
        : '<div class="' +
          S('recaptcha-checkbox-spinner-gif') +
          '" role="presentation"></div>') +
        '<div class="' +
        S('recaptcha-checkbox-checkmark') +
        '" role="presentation"></div>'
    )
    return F(X + w + '</span>')
  }
  ...
  var D_ = function (w, F) {
    ...
    a_('JS_FASTCLICK') &&
      ((E9 && LU) || KU || I1) &&
      cu(this.A, ['touchstart', 'touchend'], this.D, !1, this)
    F ||
      (cu(this.J, 'action', this.R, !1, this),
      cu(this.A, 'keyup', this.Y, !1, this))
  }
  O(D_, KA)
  D_.prototype.D = function (w) {
    if (w.type == 'touchstart') (this.K = e()), w.A()
    else if (w.type == 'touchend') {
      var F = e() - this.K
      if (w.Y8.cancelable != 0 && F < 500) return this.R(w, !0)
    }
    return !0
  }
  D_.prototype.Y = function (w) {
    return w.keyCode == 32 && w.type == 'keyup' ? this.R(w) : !0
  }
  D_.prototype.R = function (w, F) {
    var X = e() - this.K
    if (F || X > 1e3) {
      ;(w.type = 'action'), this.dispatchEvent(w), w.A(), w.preventDefault()
    }
    return !1
  }
  ...
  var pn = function (w, F) {
    ...
    this.R = 1
    this.T = null
    this.tabIndex = w && isFinite(w) && w % 1 == 0 && w > 0 ? w : 0
  }
  O(pn, M)
  z = pn.prototype
  z.C = function () {
  ...
  z.P = function () {
    ...
    if (this.KY) {
      ...
      this.T &&
        w
          .U(new D_(this.T), 'action', this.ep)
          .U(this.T, 'mouseover', this.dN)
          .U(this.T, 'mouseout', this.kP)
          .U(this.T, 'mousedown', this.Yy)
          .U(this.T, 'mouseup', this.DU)
      w
        .U(new D_(this.V()), 'action', this.ep)
        .U(new NP(document), 'action', this.ep)
    }
    if (this.T) {
      if (!this.T.id) {
        w = this.T
  ...
  z.mk = function (w) {
    return w.keyCode == 32 || w.keyCode == 13 ? (this.ep(w), !0) : !1
  }
  z.ep = function (w) {
    w.A()
    if (this.isEnabled() && this.R != 3 && !w.target.href) {
      var F = !this.A()
      this.dispatchEvent(F ? 'before_checked' : 'before_unchecked') &&
        (w.preventDefault(), this.Ma(F))
    }
  }
  z.Af = function () {
    return (
      ...
      !(
        this.isEnabled() &&
        this.V() &&
        G3(this.V(), 'recaptcha-checkbox-clearOutline')
      )
    )
  }
  z.cS = function (w) {
  ...
  pn.prototype.Ma = function (w) {
    ;(w && this.A()) || (!w && this.R == 1) || dw(this, w ? 0 : 1)
  }
  pn.prototype.Ja = function () {
    this.R == 2 || dw(this, 2)
  }
  pn.prototype.I4 = function () {
    return this.R == 3 ? MW() : dw(this, 3)
  }
  var dw = function (w, F) {
      if (
        (F == 0 && w.A()) ||
      ...
      F == 2 && w.cS(!1)
      w.R = F
      zk(w, 'recaptcha-checkbox-checked', F == 0)
      zk(w, 'recaptcha-checkbox-expired', F == 2)
      zk(w, 'recaptcha-checkbox-loading', F == 3)
      var X = w.V()
      X && eF(X, 'checked', F == 0 ? 'true' : 'false')
    ...
    if (!this.B) {
      ...
      Gq() &&
        R(this).U(
          ...
          v(function () {
            Gq()
            var F = (fk(w, 'transform') || 'rotate(0deg)').replace(
              /^rotate\(([-0-9]+)deg\)$/,
              '$1'
            )
            isFinite(F) && (F = String(F))
            F = I(F)
              ? /^\s*-?0x/i.test(F) ? parseInt(F, 16) : parseInt(F, 10)
              : NaN
  ...
  z.Ma = function (w) {
    if (!((w && this.A()) || (!w && this.R == 1) || this.X)) {
      var F = this.R,
        ...
        Y = m3(this, !0)
      if (this.R == 3) var y = Bg(this, !1, void 0, !w)
      else (y = R4()), Y.add(this.A() ? x7(this, !1) : Q2(this, !1, F, c))
  ...
  z.Ja = function () {
    if (this.R != 2 && !this.X) {
      var w = this.R,
        ...
        c = m3(this, !0)
      if (this.R == 3) var g = Bg(this, !1, void 0, !0)
      else (g = R4()), c.add(this.A() ? x7(this, !1) : Q2(this, !1, w, F))
      g.then(X)
      c.add(Q2(this, !0, 2, !1))
      g.then(function () {
        c.D()
  ...
  z.I4 = function () {
    if (this.R == 3 || this.X) return MW()
    var w = bS()
    Bg(this, !0, w)
    return w.R
  }
  var Bg = function (w, F, X, c) {
      if (F == (w.R == 3)) return R4()
      if (F) {
        F = w.R
        c = w.Af()
        var g = m3(w)
  ...
  var Q2 = function (w, F, X, c) {
    ...
    rw = function (w, F) {
      var X = v(function () {
          ...
          t(
            v(function () {
              this.R == 3 && this.B.R != 1 && (this.If(!1), this.B.D(!0))
            }, this),
            472
          )
        }, w),
    ...
    m3 = function (w, F) {
      var X = new eO()
      F &&
        (F0(R(w), X, 'play', v(w.CI, w, !0)),
        F0(R(w), X, 'end', v(w.CI, w, !1)))
      return X
    },
    Pg = function (w, F) {
      var X = new Oh(
        w.N ? G(F.J, w.N || w.K.R) : null,
        F.size,
        F.A,
        F.time,
        void 0,
  ...
  var NH = {
    ...
    $7 = { 2: 'rc-anchor-dark', 1: 'rc-anchor-light' },
    bL = function (w) {
      return NH[w] || NH[0]
    }
  ...
  var Wg = function () {
    ...
    wQ = function (w, F) {
      for (var X = d.recaptcha; w.length > 1;) (X = X[w[0]]), (w = w.slice(1))
    ...
    Fl = function (w) {
      return new CA(function (F) {
        var X = JQ(document, 'img', null, w)
        X.length == 0
          ? F()
          : cu(X[0], 'load', function () {
            F()
          })
      })
    },
    Xl = function (w, F) {
      ...
      for (
        ...
        ;(X -= 2), Qq(w, 'fontSize', X + 'px'), (c = i9(w).height)
      }
    }
  var cI = function () {
      this.R = []
    ...
    gQ = function (w, F, X) {
      if ((X = void 0 === X ? !1 : X)) {
        if (F && F.attributes && (pV(w, F.tagName), F.tagName != 'INPUT')) {
          for (var c = 0; c < F.attributes.length; c++) {
            pV(w, F.attributes[c].name + ':' + F.attributes[c].value)
          }
        }
      } else for (c in F) pV(w, c)
      F.nodeType == 3 && F.wholeText && pV(w, F.wholeText)
      if (F.nodeType == 1) {
        for (F = F.firstChild; F;) gQ(w, F, X), (F = F.nextSibling)
      }
    },
    pV = function (w, F) {
      w.R.length >= 100 && (w.R = [Yv(yc(w.R)).toString()])
      w.R.push(F)
    },
    Yv = function (w) {
      var F = 0
    ...
    TD = function () {
      var w = []
      try {
        for (var F = (0, d.gd_.gd_)().firstChild; F;) {
          w.push(ak(F)), (F = F.nextSibling)
        }
      } catch (X) {}
      return WD(w)
    }
  function yc (w) {
    var F = ''
    var X = typeof w
    if (X === 'object') for (var c in w) F += '[' + X + ':' + c + yc(w[c]) + ']'
    else {
      F =
        X === 'function'
          ? F + ('[' + X + ':' + w.toString() + ']')
  ...
  E4.prototype.add = function (w) {
    for (var F = !1, X = 0; X < this.K; X++) {
      ...
      this.A[Math.floor(c / 6)][c % 6] == 0 &&
        ((this.A[Math.floor(c / 6)][c % 6] = 1), (F = !0))
      w = '' + w
    }
    return F
  }
  E4.prototype.toString = function () {
    for (var w = [], F = 0; F < this.J; F++) {
      ...
      w.push(
        'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt(
          parseInt(Array.prototype.join.call(X, ''), 2)
        )
      )
    }
  ...
  var Ik = ['uib-']
  function KV (w) {
    if (w.nodeType == 3) return !1
    if (w.innerHTML) {
      for (var F = T0(Ik), X = F.next(); !X.done; X = F.next()) {
        if (w.innerHTML.indexOf(X.value) != -1) return !1
      }
    }
    return w.nodeType == 1 && w.src && Wg().test(w.src) ? !1 : !0
  }
  var s4 = jP(function (w, F, X) {
      ...
      for (c = 0; c < w.length; c++) {
        ...
        a: {
          ...
          if (ZI(y) && ZI(p) && y.length == p.length) {
            for (var T = y.length, K = Es, B = 0; B < T; B++) {
              if (!K(y[B], p[B])) {
                y = !1
                break a
              }
        ...
        for (p = y = 0; p < g.length && y < 25; p++) Y.add('' + D$(g[p])) && y++
        F.push(Y.toString())
      }
      return F
    }),
    AW = jP(function () {
      for (
        var w = new E4(60, 2), F = document.cookie.split(';'), X = 0, c = 0;
        c < F.length && X < 20;
        c++
      ) {
        w.add(F[c].split('=')[0].trim()) && X++
      }
      return w.toString()
    }),
    kv = jP(function () {
      for (var w = jF(document, YO), F = 0; F < w.length; F++) {
        if (w[F].src && Wg().test(w[F].src)) return F
      }
      return -1
    }),
    hW = /[^\{]*\{([\s\S]*)\}$/
  ...
  var O4 = jP(function (w) {
    ...
    xv = jP(function () {
      try {
        if (Z().parent != Z() || Z().frameElement != null) return !0
      } catch (w) {
        return !0
      }
      return !1
    ...
    fV = jP(function () {
      for (
        var w = new E4(60, 2),
          F = jF(document, function (w) {
            return (
              (w.tagName == 'INPUT' || w.tagName == 'TEXTAREA') && w.value != ''
            )
          }),
          X = 0,
          c = 0;
    ...
    tW = jP(function () {
      ...
      return vI(w[w.length - 1])
    }),
    i0 = jP(function (w) {
      return (w = (w = PI(w, 13)) && w.match(/[\s\S]*at (.*)/)) && w.length >= 2
        ? eP(w[1])
        : 'null'
    }),
    U4 = jP(function () {
      ...
      w[F].src
        ...
        : ((w = w[F].text),
        (w = a_('JS_SC')
          ? w.replace(/(["'`])(?:\\\1|.)*?\1/g, '').replace(/[^a-zA-Z]/g, '')
          : Vc(w)))
      return F + ',' + eP(w)
    }),
    Rk = jP(function () {
  ...
  function M4 (w) {
    w = w.split('')
    w.splice(1, 0, ':')
    for (w.splice(1, 0, ':'); w[0] != 'r';) w.push(w.shift())
    return w.join('')
  }
  function JW (w, F, X) {
    try {
  ...
  function $v (w) {
    var F = Z()
    return w == 1 ? F.sessionStorage : F.localStorage
  }
  function N4 (w) {
    var F = ok(M4('car'), 0) || JW(M4('car'), nq(), 0)
    F
      ? ((F = new TG(new sx(), Kq(F))),
      F.reset(),
      F.J(w),
      (w = F.K()),
      (w = Aj(w).slice(0, 4)))
  ...
  var SP = function (w) {
    ...
    l0 = function (w, F, X) {
      ...
      if (!x || Pe('8')) {
        for (var g = o1(w.A, ta, 1), Y = 0; Y < g.length; Y++) {
          w.R.push(WI(g[Y])), X.call(void 0, WD(w.R), new Date().getTime() - c)
        }
      }
  ...
  var pY = function () {
    Y2.call(
      ...
      function (w) {
        return w.W && xS(w) == 4 ? w.W.getAllResponseHeaders() || '' : ''
      },
      'HEAD'
    )
    var w = this,
      F = Z().location.search
    F.length > 0 &&
      new gj(F.slice(1)).forEach(function (F, c) {
        j2(w.A, c, F)
      })
  }
  xj(pY, Y2)
  ...
  var mH = [8],
    x2 = function (w, F) {
      ...
      c == null ||
        I(c) ||
        (U9 && c instanceof Uint8Array ? (c = CU(c)) : (G0(c), (c = null)))
      X = {
        label: X,
        kX: c,
        Xb: L(F, 3),
  ...
  var Ze = function (w, F) {
    ...
    if ((T = X = n(F, Eb, 6))) {
      ;(T = X), (X = { H1: Jk(o1(T, KY, 1), k2, w) }), w && (X.BU = T), (T = X)
    }
    var K
    if ((K = X = n(F, nY, 7))) {
      ;(K = { Az: $G(X, 1), iW: $G(X, 2) }), w && (K.BU = X)
    }
    var B
    if ((B = X = n(F, Tn, 8))) {
      ;(B = { format: L(X, 1), MX: L(X, 2) }), w && (B.BU = X)
    }
    var r
  ...
  var lq = function (w, F, X) {
    ...
    wI = function (w) {
      return WL(function () {
        var F = JSON.parse(w)
        return new lq(
          JSON.parse(Vz(SE(kg(F.message), F.messageType + F.Us))),
          F.messageType,
          F.Us
        )
      })
  ...
  function XI (w) {
    ...
    F = wj(F, '', void 0)
    w = WS(XO(F, ''), z3(w))
    w.K != null || (w.R == 'https' ? lt(w, 443) : w.R == 'http' && lt(w, 80))
    return w.toString()
  }
  var gI = function (w, F, X, c) {
    ...
    F.forEach(function (w, F) {
      for (var X = T0(k(F) ? F : [F]), c = X.next(); !c.done; c = X.next()) {
        g.J.set(c.value, w)
      }
    })
    this.K = X
  ...
  var yR = function (w, F, X, c) {
    ...
    cR = function (w, F) {
      ...
      if (c == 'x' || c == 'y') {
        Y &&
          w.A.has(Y) &&
          (c == 'x' ? w.A.get(Y).resolve(g) : w.A.get(Y).reject(g),
          w.A['delete'](Y))
      } else if (w.J.has(c)) {
        var y = w.J.get(c)
  ...
  var aw = function (w, F, X, c) {
    ...
    Dh = function (w, F, X, c, g) {
      ...
      var Y = function (X) {
        X = X.Y8
        var c = XI(X.origin) == XI(F),
          g = !w || X.source == w.contentWindow
        return c && g && X.ports.length > 0 ? X.ports[0] : null
      }
  ...
  var dI = function (w) {
      var F = w.F.A
      F
        ? ((w.A = aw(Z().parent, F, new Map([[['g', 'n', 'h', 'i'], w.K]]), w)),
        T4(w),
        w.U(w.H, 'b', v(w.K, w, null, 'eb')),
        t(function () {
          return w.K(null, 'm')
        }, 1e3 * w.F.T),
        w.F.R || (w.A.send('f', z4(w)), w.F.Y && w.K(null, 'ea')))
        : ((w.R = 'h'), aw(Z().parent, '*').send('j'))
    },
    T4 = function (w) {
      w.J = Dh(
        null,
  ...
  z.EW = function (w) {
    w.J
      ...
      : this.R == 'c'
        ? (this.R = 'e')
        : w.A && w.A.width <= 0 && w.A.height <= 0
          ? ((this.R = 'b'),
          this.J.then(function (F) {
            return F.send('g', new $2(w.R))
          }, h0))
          : ((this.R = 'e'), this.A.send('e', w))
  }
  z.rx = function (w) {
    this.A.send('e', w)
  }
  ...
  var Iw = function (w) {
    ...
    KC = function (w, F) {
      ...
      var c = X.then(function (F) {
        ...
        g = new CA(function (F) {
          w.Y.isEnabled() || F('')
          wR(w.Y, function (w) {
            w.type == 'error' ? F('') : w.type == 'finish' && F(w.data)
          })
          XV(w.Y, w.F.l)
        })
      return o4([
    ...
    z4 = function (w) {
      var F = { hl: 'en', v: 'v1536180392857' }
      F.k = Y7()
      var X = new gj()
      X.D(F)
      return new Jd(w.H.px(), {
        query: X.toString(),
  ...
  var Ol = function (w) {
      if (b(w.size, 1)) {
        ...
        w = J(
          '<div class="' +
            ...
            S('rc-anchor-content') +
            '">' +
            (G1(g) || w > 0 ? VR({ errorMessage: g, errorCode: w }) : vR()) +
            '</div><div class="' +
            S('rc-anchor-normal-footer') +
            '">' +
            J(
              '<div class="' +
                S('rc-anchor-logo-portrait') +
                '" aria-hidden="true" role="presentation">' +
                (G1(x) && b(O9, '8.0')
                  ? '<div class="' +
                    S('rc-anchor-logo-img-ie8') +
                    ' ' +
                    S('rc-anchor-logo-img-portrait') +
                    '"></div>'
                  : '<div class="' +
                    S('rc-anchor-logo-img') +
                    ' ' +
                    S('rc-anchor-logo-img-portrait') +
                    '"></div>') +
                '<div class="' +
                S('rc-anchor-logo-text') +
                '">reCAPTCHA</div></div>'
            ) +
            eq({ locale: c }) +
            '</div></div>'
        ...
        b(w.size, 2)
          ...
          (w = J(
            '<div class="' +
                ...
                S('rc-anchor-content') +
                '">' +
                (g ? VR({ errorMessage: g, errorCode: w }) : vR()) +
                '</div><div class="' +
                S('rc-anchor-compact-footer') +
                '">' +
                J(
                  '<div class="' +
                    S('rc-anchor-logo-landscape') +
                    '" aria-hidden="true" role="presentation" dir="ltr">' +
                    (G1(x) && b(O9, '8.0')
                      ? '<div class="' +
                        S('rc-anchor-logo-img-ie8') +
                        ' ' +
                        S('rc-anchor-logo-img-landscape') +
                        '"></div>'
                      : '<div class="' +
                        S('rc-anchor-logo-img') +
                        ' ' +
                        ...
                        '"></div>') +
                    '<div class="' +
                    S('rc-anchor-logo-landscape-text-holder') +
                    '"><div class="' +
                    S('rc-anchor-center-container') +
                    '"><div class="' +
                    S('rc-anchor-center-item') +
                    ' ' +
                    S('rc-anchor-logo-text') +
    ...
    BR = function (w) {
      return J(
        '<div class="' +
          S('rc-anchor') +
          ' ' +
          S('rc-anchor-invisible') +
          ' ' +
          S(w.ZR) +
          '  ' +
          (b(w.u2, 1) || b(w.u2, 2)
            ? S('rc-anchor-invisible-hover')
            : S('rc-anchor-invisible-nohover')) +
          '">' +
          kX({ cU: w.cU }) +
          hl() +
          (b(b(w.u2, 1), w.g9)
            ? PR({ locale: w.locale }) + m$({ locale: w.locale })
            : m$({ locale: w.locale }) + PR({ locale: w.locale })) +
          '</div>'
      )
    },
    PR = function (w) {
    ...
    m$ = function (w) {
      var F = J,
        X = '<div class="' + S('rc-anchor-normal-footer') + '">'
      var c = J(
        '<div class="' +
          S('rc-anchor-logo-large') +
          '" role="presentation">' +
          (G1(x) && b(O9, '8.0')
            ? '<div class="' +
              S('rc-anchor-logo-img-ie8') +
              ' ' +
              S('rc-anchor-logo-img-large') +
              '"></div>'
            : '<div class="' +
              S('rc-anchor-logo-img') +
              ' ' +
    ...
    kX = function (w) {
      return J(
        '<div id="' +
          S('recaptcha-accessible-status') +
          '" class="' +
          S('rc-anchor-aria-status') +
          '" aria-hidden="true">' +
          N(w.cU) +
          '. </div>'
      )
    ...
    vR = function () {
      var w =
        ...
        S('rc-anchor-center-item') +
        ' ' +
        S('rc-anchor-checkbox-label') +
        '" aria-hidden="true" role="presentation"><span aria-live="polite" aria-labelledby="' +
        S('recaptcha-accessible-status') +
        '"></span>'
      return J(w + "I'm not a robot</label></div></div>")
    },
    hl = function () {
      return J(
        '<div class="' +
          S('rc-anchor-error-msg-container') +
          '" style="display:none"><span class="' +
          S('rc-anchor-error-msg') +
    ...
    VR = function (w) {
      ...
      switch (V(X) ? X.toString() : X) {
        ...
        case 2:
          ...
          break
        case 3:
          F += 'This site key is not enabled for the invisible captcha.'
          break
        case 4:
          F +=
        ...
        case 5:
          ...
          break
        case 6:
          F += 'ERROR for site owner:<br>Invalid domain for site key'
          break
        case 7:
          F += 'ERROR for site owner: Invalid site key'
          break
        case 8:
          F += 'ERROR for site owner: Invalid key type'
          break
        case 9:
          F += 'ERROR for site owner: Invalid package name'
          break
        case 10:
          F += 'ERROR for site owner: Action name invalid g.co/recaptcha/action'
          break
        default:
          F = F + 'ERROR for site owner:' + ('<br>' + N(w.errorMessage))
      }
  ...
  var QR = function (w) {
    new xX(L(n(w, Cn, 6), 1), L(n(w, Cn, 6), 2), L(w, 7), w.Na() || 0).render(
      document.body
    )
  }
  ...
  z.C = function () {
    this.N = H8(Ol, {
      size: this.WU,
      ZR: this.ZR,
      cU: 'Recaptcha requires verification',
      locale: 'en'
    })
    this.S(this.V())
  }
  ...
  z.P = function () {
    ...
    R(this)
      .U(
        ...
        v(function (w) {
          w.type == 'before_checked' && this.dispatchEvent('b')
          w.preventDefault()
        }, this)
      )
      .U(
        ...
        'focus',
        function (w) {
          ;(w.target && w.target.tabIndex == 0) || this.AO.V().focus()
        },
        this
      )
  }
  ...
  z.handleError = function (w) {
    var F = bL(w)
    this.AO.Ma(!1)
    w != 2 && (this.AO.If(!1), this.LK(!0, F), SV(this, F))
  }
  z.MZ = function () {
    rI.$.MZ.call(this)
    this.AO.Ja()
  ...
  fC.prototype.C = function () {
    ...
    O2(function () {
      ...
      ;(i9(F[0]).width + i9(F[1]).width > 160 || i9(X).width > 160) &&
        Za(G('rc-anchor-invisible-text', void 0), 'smalltext')
      F = w.querySelectorAll('.rc-anchor-normal-footer .rc-anchor-pt a')
      i9(F[0]).width + i9(F[1]).width > 65 &&
        Za(G('rc-anchor-normal-footer', void 0), 'smalltext')
    }, this)
    this.S(this.V())
  }
  ...
  var LC = function (w) {
    ...
    var F = L(n(w, Cn, 6), 1),
      X
    F == 3
      ? (X = new fC(L(n(w, Cn, 6), 2), L(n(w, Cn, 6), 3)))
      : (X = new rI(L(n(w, Cn, 6), 2), F))
  ...
  var HR = function () {
    return J(
      '<div class="' +
        ...
        S('button-holder') +
        ' ' +
        S('reload-button-holder') +
        '"></div><div class="' +
        S('button-holder') +
        ' ' +
        S('audio-button-holder') +
        '"></div><div class="' +
        S('button-holder') +
        ' ' +
        S('image-button-holder') +
        '"></div><div class="' +
        S('button-holder') +
        ' ' +
        S('help-button-holder') +
        '"></div><div class="' +
        S('button-holder') +
        ' ' +
        S('undo-button-holder') +
        '"></div></div><div class="' +
        S('verify-button-holder') +
        '"></div></div><div class="' +
        S('rc-challenge-help') +
  ...
  var nC = function (w) {
      return J(
        '<span class="' +
          S('rc-audiochallenge-tabloop-begin') +
          '" tabIndex="0"></span><div class="' +
          S('rc-audiochallenge-error-message') +
          '" style="display:none" tabIndex="0"></div><div class="' +
          S('rc-audiochallenge-instructions') +
          '" id="' +
          S(w.WR) +
          '" aria-hidden="true"></div><div class="' +
          S('rc-audiochallenge-control') +
          '"></div><div id="' +
          S('rc-response-label') +
          '" style="display:none"></div><div class="' +
          S('rc-audiochallenge-response-field') +
          '"></div><div class="' +
          S('rc-audiochallenge-tdownload') +
          '"></div>' +
          N(HR()) +
          '<span class="' +
          S('rc-audiochallenge-tabloop-end') +
          '" tabIndex="0"></span>'
      )
    },
    u2 = function (w) {
      return J(
        '<div class="' +
          S('rc-audiochallenge-play-button') +
    ...
    Zh = function (w) {
      w =
        '<a class="' +
        S('rc-audiochallenge-tdownload-link') +
        '" target="_blank" href="' +
        S(o2(w.ig)) +
        '" title="'
      w += 'Alternatively, download audio as MP3'.replace(iV, UY)
      return J(w + '"></a>')
    },
    CC = function (w) {
      w = w || {}
      var F = ''
      w.CZ || (F += 'Press R to replay the same challenge. ')
      return J(
        F +
  ...
  tl.prototype.If = function (w) {
    ...
    if (w) {
      this.R = w = this.R
      var F = this.V()
      F && (w >= 0 ? (F.tabIndex = this.R) : KS(F, !1))
  ...
  W.prototype.P = function () {
    ...
    R(this).U(this.V(), 'keyup', function (w) {
      w.keyCode == 27 && this.dispatchEvent('e')
    })
  ...
  var Jl = function (w, F, X) {
    if (w.D.width != F.width || w.D.height != F.height) {
      ;(w.D = F), X && Mn(w, ys), w.dispatchEvent('d')
    }
  }
  W.prototype.pY = a()
  ...
  var $X = function (w, F, X, c) {
      ...
      CG(w.D).width != w.pI().width || CG(w.D).height != w.pI().height
        ? (Mn(w, g), Jl(w, w.pI()))
        : g()
    },
    ow = function (w) {
  ...
  var l = function (w, F, X) {
    ...
    if (F || !X || JO(X)) {
      ...
      !X ||
          ...
          (c.height +=
            (F ? 1 : -1) *
            (i9(X).height + WP(X, 'margin').top + WP(X, 'margin').bottom)),
          Jl(w, c, !F)),
      F || w.u_(!1, X)
    }
  }
  ...
  var Rw = function (w, F) {
      var X = G('rc-challenge-help', void 0),
        c = !JO(X)
      if (F == null || F == c) {
        if (c) {
          w.k8(X)
    ...
    i2 = function (w, F, X, c, g, Y, y) {
      ...
      g &&
        ((F.VJ = g), (c = F.V())) &&
        (g ? (c.title = g) : c.removeAttribute('title'))
      Y && T1(F, Y)
      y && sY(F, 16, !0)
      JD(w, F)
      return F
    ...
    b2 = function () {
      if (I1 || KU) {
        ...
        z$ || E9
          ? ((w = window.outerWidth || screen.availWidth || screen.width),
          (F = window.outerHeight || screen.availHeight || screen.height),
          LU || (F -= 20))
          : ((w =
              window.outerWidth ||
              window.innerWidth ||
  ...
  W.prototype.yJ = a()
  var Sq = function (w) {
    for (var F = w || ['rc-challenge-help'], X = 0; X < F.length; X++) {
      if ((w = G(F[X])) && JO(w) && JO(pS(w))) {
        ;(F =
          w.tagName == 'A' ||
          w.tagName == 'INPUT' ||
          w.tagName == 'TEXTAREA' ||
          w.tagName == 'SELECT' ||
          w.tagName == 'BUTTON'
            ? !w.disabled && (!sP(w) || Ab(w))
            : sP(w) && Ab(w)) &&
          x &&
          ((F = void 0),
          (X = w),
          !h(X.getBoundingClientRect) || (x && X.parentElement == null)
            ? (F = { height: X.offsetHeight, width: X.offsetWidth })
            : (F = X.getBoundingClientRect()),
          (F = F != null && F.height > 0 && F.width > 0))
  ...
  W.prototype.k8 = a()
  var WR = function (w, F) {
    OY.call(this, I(w) ? w : 'Type the text', F)
  }
  O(WR, OY)
  ...
  var qn = new u(280, 275),
    wH = new u(280, 235),
    Fk = function () {
      z$ || E9 || KU || I1
        ? W.call(this, wH.width, wH.height, 'audio', !0)
        : W.call(this, qn.width, qn.height, 'audio', !0)
      this.G = z$ || E9 || KU || I1
      this.A = this.X = null
      this.R = new WR('')
  ...
  z.P = function () {
    ...
    var w = this.R.V()
    R(this)
      .U(G('rc-audiochallenge-tabloop-begin'), 'focus', function () {
        Sq()
      })
      ...
      .U(w, 'keydown', function (w) {
        w.ctrlKey && w.keyCode == 17 && this.jw()
      })
    this.A = this.w('rc-audiochallenge-error-message')
    gi(this.i_, document)
    R(this).U(this.i_, 'key', this.fZ)
  }
  z.zn = function (w) {
  ...
  z.fZ = function (w) {
    w.keyCode == 13
      ? this.o4()
      : this.G && this.A && hb(this.A).length > 0 && l(this, !1)
  }
  z.vU = function () {
    this.T && this.T.pause()
    return /^[\s\xa0]*$/.test(f3(this.R))
      ? (R9(document, 'audio-instructions').focus(), !0)
      : !1
  }
  z.zl = function (w, F, X) {
    l(this, !!X)
    ...
    Hq(this.R, !0)
    this.G ||
      rj(this.w('rc-audiochallenge-tdownload'), Zh, {
        ig: this.gO(w, void 0, '/audio.mp3')
      })
    document.createElement('audio').play
      ? (F && n(F, Tn, 8) && ((F = n(F, Tn, 8)), L(F, 1)),
      (F = this.w('rc-audiochallenge-instructions')),
      zu(F, 'Press PLAY and enter the words you hear'),
      this.G ||
          zu(R9(document, 'rc-response-label'), 'Press CTRL to play again.'),
      (w = this.gO(w, '')),
      rj(this.X, u2, { ig: w }),
      (this.T = R9(document, 'audio-source')),
      (w = this.w('rc-audiochallenge-play-button')),
      (F = i2(this, void 0, 'PLAY', void 0, void 0, void 0, void 0)),
      PQ(this, F),
      F.render(w),
      eF(F.V(), 'labelledby', ['audio-instructions', 'rc-response-label']),
      R(this).U(F, 'action', this.jw))
      : rj(this.X, G4)
    return R4()
  }
  z.u_ = function (w, F) {
    if (F) {
      var X = !!this.A && hb(this.A).length > 0
      Ms(this.A, w)
      l2(this.R, w)
      cQ(this.A)
      w &&
        zu(this.A, 'Multiple correct solutions required - please solve more.')
      return w != X
    }
    l(this, w, this.A)
    return !1
  ...
  z.bs = function () {
    var w
    !(w = !(this.A && hb(this.A).length > 0)) &&
      (w = Ak) &&
      (w = Gc(XA, 10) >= 0)
    w
      ? G('rc-audiochallenge-play-button', void 0).children[0].focus()
      : this.A.focus()
  }
  z.yJ = function () {
  ...
  var yi = function (w) {
    ...
    switch (V(X) ? X.toString() : X) {
      case 'stop_sign':
        F +=
          '<div class="' +
          S('rc-imageselect-candidates') +
          '"><div class="' +
          S('rc-canonical-stop-sign') +
          '"></div></div><div class="' +
      ...
      case 'multicaptcha':
        ...
        switch (V(g) ? g.toString() : g) {
          ...
          case '/m/0pg52':
            ...
            break
          case '/m/04_sv':
            c += 'Select all squares with <strong>motocycles</strong>'
            break
          case '/m/0199g':
        ...
        b(w.eQ, 'multicaptcha') &&
          ((c +=
            '<span class="' + S('rc-imageselect-carousel-instructions') + '">'),
          (c += 'If there are none, click skip.</span>'))
        w = J(c)
        X += w
        break
      default:
        ...
        switch (V(g) ? g.toString() : g) {
          ...
          case 'sidewalk':
          case 'footpath':
            c += 'Select all images with a <strong>sidewalk</strong>.'
            break
          case 'gcid:atm':
          ...
          case '/m/06_fw':
            ...
            break
          case '/m/019w40':
            c += 'Select all images with <strong>surfboards</strong>'
            break
          case '/m/04fdw':
          ...
          case '/m/07gcy':
            ...
            break
          case '/m/019cfy':
            c += 'Select all images with a <strong>stadium</strong>.'
            break
          case '/m/03d2wd':
          ...
          case 'pants':
            ...
            break
          case 'shorts':
            c += 'Select all images with <strong>shorts</strong>.'
            break
          case 'skirt':
            c += 'Select all images with <strong>skirts</strong>.'
            break
          case 'sock':
            c += 'Select all images with <strong>socks</strong>.'
            break
          case '/m/01xyhv':
          case 'suit':
            ...
            break
          case 'vest':
            c += 'Select all images with <strong>vests</strong>.'
            break
          case 'dress':
            c += 'Select all images with <strong>dresses</strong>.'
            break
          case 'wedding_dress':
            c += 'Select all images with <strong>wedding dresses</strong>.'
            break
          case 'hat':
            c += 'Select all images with <strong>hats</strong>.'
            break
          case 'watch':
            c += 'Select all images with <strong>watches</strong>.'
            break
          case 'ring':
            c += 'Select all images with <strong>rings</strong>.'
            break
          case 'earrings':
            c += 'Select all images with <strong>earrings</strong>.'
            break
          case 'necklace':
            c += 'Select all images with <strong>necklaces</strong>.'
            break
          case 'bracelet':
            c += 'Select all images with <strong>bracelets</strong>.'
            break
          case 'sneakers':
            c += 'Select all images with <strong>sneakers</strong>.'
            break
          case 'boot':
            c += 'Select all images with <strong>boots</strong>.'
            break
          case 'sandal':
            c += 'Select all images with <strong>sandals</strong>.'
            break
          case 'slipper':
            c += 'Select all images with <strong>slippers</strong>.'
            break
          case 'hair_accessory':
            c += 'Select all images with <strong>hair accessories</strong>.'
            break
          case 'handbag':
            c += 'Select all images with <strong>handbags</strong>.'
            break
          case 'belt':
            c += 'Select all images with <strong>belts</strong>.'
            break
          case 'wallet':
            c += 'Select all images with <strong>wallets</strong>.'
            break
          case '/m/0342h':
          ...
          case '/m/03sy7v':
            ...
            break
          case '/m/03b6pr':
            c += 'Select all images with <strong>mail boxes</strong>'
            break
          case '/m/04w67_':
            c += 'Select all images with <strong>mail boxes</strong>'
            break
        ...
        b(w.eQ, 'dynamic') &&
          (c += '<span>Click verify once there are none left.</span>')
        w = J(c)
        X += w
    }
    w = J(X)
  ...
  var af = function () {
      return J(
        '<div id="rc-imageselect"><div class="' +
          S('rc-imageselect-response-field') +
          '"></div><span class="' +
          S('rc-imageselect-tabloop-begin') +
          '" tabIndex="0"></span><div class="' +
          S('rc-imageselect-payload') +
          '"></div>' +
          N(HR()) +
          '<span class="' +
          S('rc-imageselect-tabloop-end') +
          '" tabIndex="0"></span></div>'
      )
    },
    Dx = function (w, F, X) {
      ...
      if (b(w.eQ, 'canvas')) {
        ...
        w = J(F + '</div>')
        w = N(w)
      } else w = b(w.eQ, 'multiselect') ? N(gH(w, F)) : N(yi(w, F))
      w =
        '<div class="' +
        S('rc-imageselect-instructions') +
        '"><div class="' +
        S('rc-imageselect-desc-wrapper') +
        '">' +
        w +
        '</div><div class="' +
        S('rc-imageselect-progress') +
        '"></div></div><div class="' +
        S('rc-imageselect-challenge') +
        '"><div id="rc-imageselect-target" class="' +
        S('rc-imageselect-target') +
        '" dir="ltr" role="presentation" aria-hidden="true"></div></div><div class="' +
        S('rc-imageselect-incorrect-response') +
        '" style="display:none">'
      w =
        w +
        'Please try again.' +
        ('</div><div class="' +
          S('rc-imageselect-error-select-more') +
          '" style="display:none">')
      w =
        w +
        'Please select all matching images.' +
        ('</div><div class="' +
          S('rc-imageselect-error-dynamic-more') +
          '" style="display:none">')
      w =
        w +
        'Please also check the new images.' +
        ('</div><div class="' +
          S('rc-imageselect-error-select-something') +
          '" style="display:none">')
      return J(
        w +
    ...
    pv = function (w, F, X) {
      ...
      var c =
        '<table' +
        (b(w.rowSpan, 4) && b(w.colSpan, 4)
          ? ' class="' + S('rc-imageselect-table-44') + '"'
          : b(w.rowSpan, 4) && b(w.colSpan, 2)
            ? ' class="' + S('rc-imageselect-table-42') + '"'
            : ' class="' + S('rc-imageselect-table-33') + '"') +
        '><tbody>'
        ...
        for (var y = Math.max(0, Math.ceil(w.colSpan - 0)), p = 0; p < y; p++) {
          var T = 1 * p,
            K =
              ...
              S('rc-imageselect-tile') +
              '">',
            B = void 0
          T = { sT: Y, NZ: T }
          var r = w
          for (B in r) B in T || (T[B] = r[B])
          c += K + fP(T, F) + '</td>'
        }
        c += '</tr>'
      }
    ...
    fP = function (w) {
      var F =
        b(w.rowSpan, 4) && b(w.colSpan, 4)
          ? ' class="' + S('rc-image-tile-44') + '"'
          : b(w.rowSpan, 4) && b(w.colSpan, 2)
            ? ' class="' + S('rc-image-tile-42') + '"'
            : b(w.rowSpan, 1) && b(w.colSpan, 1)
              ? ' class="' + S('rc-image-tile-11') + '"'
              : ' class="' + S('rc-image-tile-33') + '"'
      return J(
        '<div class="' +
          S('rc-image-tile-target') +
          '"><div class="' +
          S('rc-image-tile-wrapper') +
          '" style="width: ' +
          S(Wq(w.jp)) +
          '; height: ' +
          S(Wq(w.zy)) +
          ...
          S(Wq(-100 * w.NZ)) +
          '%"><div class="' +
          S('rc-image-tile-overlay') +
          '"></div></div><div class="' +
          S('rc-imageselect-checkbox') +
          '"></div></div>'
      )
    },
    TJ = function (w) {
  ...
  q.prototype.zl = function (w, F, X) {
    ...
    this.gx = L(F, 3) || 1
    c = 'image/png'
    L(F, 6) == 1 && (c = 'image/jpeg')
    g = L(F, 7)
    g != null && (g = g.toLowerCase())
    rj(this.T, Dx, {
      label: this.Sp,
      w0: L(F, 2),
      W1: c,
    ...
    Jl(this, this.pI(), !0)
    dH(this)
    return Fl(this.BS(this.gO(w))).then(
      v(function () {
        X && l(this, !0, G('rc-imageselect-incorrect-response', void 0))
      }, this)
    )
  }
  var dH = function (w) {
    var F = G('rc-imageselect-desc', w.T),
      X = G('rc-imageselect-desc-no-canonical', w.T)
    if ((X = F || X)) {
      var c = MX('STRONG', X),
        g = MX('SPAN', X),
        Y = G('rc-imageselect-desc-wrapper', w.T),
  ...
  q.prototype.BS = function (w) {
    var F = L(n(this.us, BL, 1), 4),
      X = L(n(this.us, BL, 1), 5)
    ...
    P(
      Y,
      function (w) {
        R(this).U(w, 'keydown', v(this.xP, this, X))
      },
      this
    )
    ...
    var y = []
    this.getName() == 'tileselect' &&
      this.Sp == 'TileSelectionStreetSign' &&
      a_('JS_TILESELECT_CLASS') &&
      ((c.w9 = [
      ...
      (c = H8(TJ, c)),
      Xm(this.w('rc-imageselect-target'), c),
      P(
        JQ(document, 'td', null, c),
        function (w) {
  ...
  q.prototype.MV = function () {
    this.Sw &&
      ((this.rd = void 0),
      P(
        XS('rc-imageselect-tile'),
        function (w, F) {
          w != vQ(document)
            ? tM(w, 'rc-imageselect-keyboard')
            : ((this.rd = F), Za(w, 'rc-imageselect-keyboard'))
        },
        this
      ))
  }
  q.prototype.xP = function (w, F) {
    if (
      ...
      if (((this.Sw = !0), F.keyCode != 9)) {
        var X = []
        P(MX('TABLE'), function (w) {
          Lk(w, 'display') !== 'none' &&
            P(XS('rc-imageselect-tile', w), function (w) {
              X.push(w)
            })
        })
        var c = X.length - 1
        if (this.rd >= 0 && X[this.rd] == vQ(document)) {
          switch (((c = this.rd), F.keyCode)) {
            case 37:
              c--
              break
            case 38:
        ...
        c >= 0 && c < X.length
          ? X[c].focus()
          : c >= X.length && R9(document, 'recaptcha-verify-button').focus()
        F.preventDefault()
        F.A()
      }
    }
  ...
  q.prototype.G = function (w) {
    ...
    if (w.Bo) {
      w.selected = !1
      for (var X = Ee(this), c = 0; c < X.length; c++) {
        this.G(this.A.M.Rf.Zi[X[c]])
      }
    }
    F
      ? Za(w.element, 'rc-imageselect-tileselected')
      : tM(w.element, 'rc-imageselect-tileselected')
    w.selected = F
  ...
  q.prototype.yJ = function () {
    ...
    var w = Ee(this)
    w.length
      ? (this.response.plugin = 'class' + w[0])
      : this.A.M.Rf.Zi.length > 0 && (this.response.plugin = 'class')
  }
  var If = function (w) {
      var F = []
  ...
  z.vU = function () {
    ...
    if (w == 0 || w < this.gx) {
      return l(this, !0, G('rc-imageselect-error-select-more', void 0)), !0
    }
  ...
  function kW (w, F) {
    return Math.abs(w.x - F.x) <= 1e-5 && Math.abs(w.I - F.I) <= 1e-5
  }
  var h3 = function () {
    se.call(this, 'canvas')
  }
  ...
  z.CK = function (w) {
        ...
        for (c = F.length - 1; c > 0; c--) {
          ...
          if (T == K) g = !0
            ...
            Math.abs(B - 0) <= 1e-5
              ? (g = !1)
              : ((T = ZS(
                new Gz(K[1] * T[2] - T[1] * K[2], T[0] * K[2] - K[0] * T[2]),
                1 / B
              )),
              kW(T, g) || kW(T, Y) || kW(T, y) || kW(T, p)
                ? (g = !1)
                : ((y = new zg(y.x, y.I, p.x, p.I)),
                (y = jg(y, Math.min(Math.max(d8(y, T.x, T.I), 0), 1))),
                (g = new zg(g.x, g.I, Y.x, Y.I)),
                (g =
                      kW(T, jg(g, Math.min(Math.max(d8(g, T.x, T.I), 0), 1))) &&
                      kW(T, y))))
          }
          if (g) {
            c = X && c == 1
    ...
    c
      ? (X ? (F.push(F[0]), this.R.push([])) : F.push(w), this.PU())
      : (this.PU(w), t(this.PU, 250, this))
  }
  z.pY = function () {
    var w = this.R.length - 1
    this.R[w].length == 0 && w != 0 && this.R.pop()
    w = this.R.length - 1
    this.R[w].length != 0 && this.R[w].pop()
    this.PU()
  }
  z.PU = function (w) {
    var F = G('rc-canvas-canvas', void 0),
    ...
    X.lineWidth = 2
    x && (X.setLineDash = a())
    for (F = 0; F < this.R.length; F++) {
      if (((c = this.R[F].length), c != 0)) {
        F == this.R.length - 1 &&
          (w &&
            (X.beginPath(),
            (X.strokeStyle = 'rgba(255, 50, 50, 1)'),
            X.moveTo(this.R[F][c - 1].x, this.R[F][c - 1].I),
            X.lineTo(w.x, w.I),
            X.setLineDash([0]),
            X.stroke(),
            X.closePath()),
          ...
          X.arc(this.R[F][c - 1].x, this.R[F][c - 1].I, 3, 0, 2 * Math.PI),
          X.fill(),
          X.closePath())
        X.beginPath()
  ...
  z.vU = function () {
    var w
    if (!(w = this.R[0].length <= 2)) {
      for (var F = (w = 0); F < this.R.length; F++) {
        for (var X = this.R[F], c = X.length - 1, g = 0; g < X.length; g++) {
          ;(w += (X[c].x + X[g].x) * (X[c].I - X[g].I)), (c = g)
        }
      }
      w = Math.abs(0.5 * w) < 500
    }
    return w
      ? (l(this, !0, G('rc-imageselect-error-select-something', void 0)), !0)
      : !1
  }
  z.k8 = function (w) {
    rj(w, cy)
  ...
  Vi.prototype.pY = function () {
    var w = this.R.length - 1
    this.R[w].length != 0 && this.R[w].pop()
    this.R[w].length == 0 && Nn(this, 'None Found', !0)
    this.PU()
  }
  Vi.prototype.BS = function (w) {
    ...
    vy(this)
    Kv(0, 1)
    Nn(this, 'None Found', !0)
    return w
  }
  Vi.prototype.PU = function () {
    this.R.length == 0 ? Kv(0, 1) : Kv(this.R.length - 1, 3)
    var w = G('rc-canvas-canvas', void 0),
      F = w.getContext('2d'),
      X = G('rc-canvas-image', void 0)
    ...
    for (var c = 0; c < this.R.length; c++) {
      ...
      for (var g = 0; g < this.R[c].length; g++) {
        w.beginPath(),
        w.arc(this.R[c][g].x, this.R[c][g].I, 20, 0, 2 * Math.PI),
        w.fill(),
        w.closePath()
      }
    }
  ...
  var eX = function () {
      var w =
        ...
        S('rc-defaultchallenge-response-field') +
        '"></div><div class="' +
        S('rc-defaultchallenge-payload') +
        '"></div><div class="' +
        S('rc-defaultchallenge-incorrect-response') +
        '" style="display:none">'
      w =
        w +
    ...
    Oe = function (w) {
      ...
      w += 'reCAPTCHA challenge image'.replace(iV, UY)
      return J(w + '"/>')
    },
    Py = function () {
      return J(
  ...
  var By = function () {
    ...
    var w = (this.R = new WR()),
      F = w.V()
    mD()
      ? (F && (F.placeholder = 'Type the text'), (w.R = 'Type the text'))
      : QC(w) || (F && (F.value = ''), (w.R = 'Type the text'), w.B())
    F && eF(F, 'label', w.R)
    PQ(this, this.R)
    this.A = new YH()
    PQ(this, this.A)
  ...
  z.x7 = function (w) {
    w.keyCode == 13 && this.o4()
  }
  z.s9 = function () {
    f3(this.R).length > 0 && l(this, !1)
  }
  z.vU = function () {
    return /^[\s\xa0]*$/.test(f3(this.R))
  }
  ...
  var xW = function () {
    var w =
      '<div><div class="' +
      S('rc-doscaptcha-header') +
      '"><div class="' +
      S('rc-doscaptcha-header-text') +
      '">'
    w =
      w +
      'Try again later' +
      ('</div></div><div class="' +
        S('rc-doscaptcha-body') +
        '"><div class="' +
        S('rc-doscaptcha-body-text') +
        '" tabIndex="0">')
    w =
      w +
      ...
      ('</div></div></div><div class="' +
        S('rc-doscaptcha-footer') +
        '">' +
        N(HR()) +
        '</div>')
    return J(w)
  }
  var Qi = new u(300, 250),
    rH = function () {
  ...
  rH.prototype.zl = function () {
    Ul(this, !1)
    var w = this.w('rc-doscaptcha-header-text'),
      F = this.w('rc-doscaptcha-body'),
  ...
  nv.prototype.ab = function (w, F) {
    w.length == 0 && (this.CI = !0)
    zc(this.R, w)
    zc(this.xy, F)
    this.X.length == this.R.length + 1 - w.length &&
      (this.CI ? this.dispatchEvent('k') : u6(this))
  }
  var u6 = function (w) {
      Za(
        Dq(w.w('rc-imageselect-target')),
      ...
      if (!(w.i_ >= w.R.length)) {
        ...
        Nn(w, 'Skip')
        tM(
          G('rc-imageselect-carousel-instructions', void 0),
    ...
    GJ = function (w, F) {
      var X = vQ(document)
      Ul(w, !1)
      var c = E(F.previousElementSibling)
        ? F.previousElementSibling
        : yt(F.previousSibling, !1)
      Za(F, 'rc-imageselect-carousel-offscreen-right')
      Za(c, 'rc-imageselect-carousel-leaving-left')
      Za(
        F,
        w.A.M.Rf.rowSpan == 4 && w.A.M.Rf.colSpan == 4
        ...
        v(function () {
          t(
            function () {
              ...
              Za(c, 'rc-imageselect-carousel-offscreen-left')
              t(
                function () {
                  tM(F, 'rc-imageselect-carousel-entering-right')
                  tM(
                    F,
                    this.A.M.Rf.rowSpan == 4 && this.A.M.Rf.colSpan == 4
                      ? 'rc-imageselect-carousel-mock-margin-1'
                      : 'rc-imageselect-carousel-mock-margin-2'
                  )
                  g_(c)
                  ...
                  for (var Y = 0; Y < w.length; Y++) {
                    ;(w[Y].selected = !1),
                    tM(w[Y].element, 'rc-imageselect-tileselected')
                  }
                },
                600,
                this
  ...
  Zx.prototype.ab = function (w) {
    for (
      var F = {}, X = T0(Cv(this)), c = X.next();
      !c.done;
      F = { AA: F.AA, fI: F.fI, Gy: F.Gy }, c = X.next()
    ) {
      c = c.value
      if (w.length == 0) break
      this.VJ.push(c)
  ...
  var t3 = function (w) {
    Qq(G('rc-image-tile-overlay', w.element), {
      opacity: '0.5',
      display: 'block',
      top: '0px'
    })
  ...
  Zx.prototype.vU = function () {
    if (!fv.prototype.vU.call(this)) {
      if (!this.Os) {
        for (var w = T0(this.VJ), F = w.next(); !F.done; F = w.next()) {
          var X = this.X
          if (X !== null && F.value in X) return !1
        }
      }
      ...
      w.selected ||
        ...
        this.R &&
          Qq(
            w.element,
            'transition',
            'opacity ' + (this.R + 1e3) / 1e3 + 's ease'
          ),
        Za(w.element, 'rc-imageselect-dynamic-selected'),
        (w = WW(this.A.M.Rf.dO, w)),
        zc(this.Fq, w),
        Lv(this)))
  }
  var Cv = function (w) {
    ...
    P(
      w.A.M.Rf.dO,
      function (w, c) {
        w.selected && WW(this.VJ, c) == -1 && F.push(c)
      },
      w
    )
    return F
  ...
  var i6 = function () {
      var w =
        ...
        S('rc-coref-tabloop-begin') +
        '" tabIndex="0"></span><div class="' +
        S('rc-coref-select-more') +
        '" style="display:none" tabindex="0">'
      w =
        w +
        'Please fill in the answers to proceed' +
        ('</div><div class="' +
          S('rc-coref-verify-failed') +
          '" style="display:none" tabindex="0">')
      w =
        w +
        'Please try again' +
    ...
    Ue = function (w) {
      ...
      w = w.jb
      for (
        var g = '', Y = Math.max(0, Math.ceil(c.length - 0)), y = 0;
        y < Y;
        y++
      ) {
        var p = 1 * y
        ...
        var T =
          'Listen to the text and select everything that refers to: ' + N(w[p])
        g += T
        g +=
          '</div><div class="' +
          S('rc-coref-sentence') +
        ...
        for (var K = T.length, B = 0; B < K; B++) {
          ...
          r[1] &&
            ...
            (r =
              'Check the box if "' +
              (S(r[0]) + ('" refers to "' + (S(w[p]) + '"')))),
            (g += String(r).replace(iV, UY)),
            (g += '\'><div tabindex="0">'))
        }
        g += '...</div></div>'
      }
      ...
      c = F.length
      for (w = 0; w < c; w++) {
        X += '<a target="_blank" href="' + S(o2(F[w])) + '">source</a> '
      }
  ...
  z.P = function () {
    W.prototype.P.call(this)
    R(this)
      .U(this.w('rc-coref-tabloop-begin'), 'focus', function () {
        Sq()
      })
  ...
  z.zl = function (w, F, X) {
    ...
    rj(this.A, Ue, {
      nZ: $W(o1(this.R, KY, 1)),
      jb: of(o1(this.R, KY, 1)),
      Kx: N8(o1(this.R, KY, 1))
    })
    l(this, !1)
    Mn(
      this,
  ...
  var $W = function (w) {
      for (var F = [], X = 0; X < w.length; X++) {
        ...
        for (var y = 0; y < sb(w[X]).length; y++) {
          var p =
            L(sb(w[X])[y], 4) != 0 &&
            (y == sb(w[X]).length - 1 || L(sb(w[X])[y + 1], 4) == 0)
          c = c || p
          var T = L(sb(w[X])[y], 1)
          L(sb(w[X])[y], 3) != 0 && (T = ' ' + T)
    ...
    of = function (w) {
      for (var F = [], X = 0; X < w.length; X++) {
        for (var c = !1, g = 0; g < sb(w[X]).length; g++) {
          if (L(sb(w[X])[g], 4) == 2) {
            var Y = ' ' + L(sb(w[X])[g], 1)
  ...
  z.yJ = function () {
    var w = []
    P(this.N ? XS('rc-coref-checkbox', this.N || this.K.R) : [], function (
      F,
      X
    ) {
      F.checked && w.push(X)
  ...
  var b6 = function () {
      var w =
        ...
        S('rc-prepositional-tabloop-begin') +
        '" tabIndex="0"></span><div class="' +
        S('rc-prepositional-select-more') +
        '" style="display:none" tabindex="0">'
      w =
        w +
        'Please fill in the answers to proceed' +
        ('</div><div class="' +
          S('rc-prepositional-verify-failed') +
          '" style="display:none" tabindex="0">')
      w =
        w +
        'Please try again' +
        ('</div><div class="' +
          S('rc-prepositional-payload') +
          '"></div>' +
          N(HR()) +
          '<span class="' +
          S('rc-prepositional-tabloop-end') +
          '" tabIndex="0"></span></div>')
      return J(w)
    },
    SX = function (w) {
      for (
        var F =
            '<div class="' +
            S('rc-prepositional-challenge') +
            '"><div id="rc-prepositional-target" class="' +
            S('rc-prepositional-target') +
            '" dir="ltr"><div tabIndex="0" class="' +
            S('rc-prepositional-instructions') +
            '"></div><table class="' +
            S('rc-prepositional-table') +
            '" role="region">',
          X = Math.max(0, Math.ceil(w.text.length - 0)),
          c = 0;
        c < X;
        c++
      ) {
  ...
  z.P = function () {
    W.prototype.P.call(this)
    R(this)
      .U(this.w('rc-prepositional-tabloop-begin'), 'focus', function () {
        Sq()
      })
  ...
  var wx = function (w) {
    var F = G('rc-prepositional-target', void 0),
      X = []
    P(
      JQ(document, 'td', null, F),
      function (w, F) {
        this.R.push(F)
  ...
  z.ay = function (w) {
    ...
    var F = !w.selected
    F
      ? (Za(w.element, 'rc-prepositional-selected'), Dc(this.R, w.index))
      : (tM(w.element, 'rc-prepositional-selected'), this.R.push(w.index))
    w.selected = F
  ...
  z.vU = function () {
    return $G(this.A, 1).length - this.R.length < this.X
      ? (l(this, !0, this.w('rc-prepositional-select-more')), !0)
      : !1
  }
  z.k8 = function (w) {
  ...
  var cH = function () {
    ...
    gx = function (w) {
      var F = w.bn,
        X =
          '<div class="' +
          S('rc-text-instructions') +
          '"><div class="' +
          S('rc-text-desc-wrapper') +
          '" tabIndex="0">'
      ...
      for (var y = 0; y < g; y++) {
        ...
        for (var T = Math.max(0, Math.ceil(c - 0)), K = 0; K < T; K++) {
          Y +=
            '<td role="checkbox" tabIndex="0">' + N(w[1 * K + p * c]) + '</td>'
        }
        Y += '</tr>'
      }
      w = J(Y + '</table>')
  ...
  aE.prototype.P = function () {
    aE.$.P.call(this)
    R(this)
      .U(G('rc-text-tabloop-begin'), 'focus', function () {
        Sq()
      })
  ...
  z.Gr = function (w) {
    ...
    var F = !w.selected
    F
      ? (Za(w.element, 'rc-text-choice-selected'), this.A.push(w.index))
      : (tM(w.element, 'rc-text-choice-selected'), Dc(this.A, w.index))
    w.selected = F
    eF(w.element, 'checked', w.selected ? 'true' : 'false')
  }
  z.vU = function () {
    return this.A.length < L(this.R, 4)
      ? (l(this, !0, G('rc-text-select-more', void 0)), !0)
      : L(this.R, 5) && this.A.length > L(this.R, 5)
        ? (l(this, !0, G('rc-text-select-fewer', void 0)), !0)
        : !1
  }
  z.u_ = function (w, F) {
    var X = [
  ...
  z.bs = function () {
    wp(
      ...
      this
    ) || ah(G('rc-text-instructions', void 0)).focus()
  }
  z.yJ = function () {
  ...
  var jU = {
      normal: new u(304, 78),
      compact: new u(164, 144),
      invisible: new u(256, 60)
    },
    Eu = function (w, F) {
      l1.call(this)
      this.KK = w
  ...
  xj(Eu, l1)
  var IE = function (w, F) {
      var X = F ? w.Jf.left - 10 : w.Jf.left + w.Jf.width + 10,
        c = u9(w.vd()),
        g = w.Jf.top + 0.5 * w.Jf.height
      X instanceof Gz
        ? ((c.x += X.x), (c.I += X.I))
        : ((c.x += Number(X)), f7(g) && (c.I += g))
      return c
    },
    KO = function () {
      var w = br(window).width,
        F = Z().innerWidth
      F && F < w && (w = F)
  ...
  Eu.prototype.K = function (w) {
    ...
    this.R = H8(w == 'fullscreen' ? dx : z5, { left: 0, top: -1e4 })
  ...
  var kz = function (w, F, X) {
    ...
    hc = function (w, F, X) {
      var c = fk(w.R, 'visibility') == 'visible'
      Qq(w.R, {
      ...
      c && !F
        ...
        : F && (d.clearTimeout(w.o), Qq(w.R, 'top', '0px'))
      X && (Ck(Dq(w.R), X.width, X.height), Ck(ah(Dq(w.R)), X.width, X.height))
    }
  Eu.prototype.B = function () {
    e() - this.T > 25
      ? (Vb(this), (this.T = e()))
      : (d.clearTimeout(this.Y), (this.Y = t(this.B, 25, this)))
  }
  var Vb = function (w) {
      if (fk(w.R, 'visibility') == 'visible') {
        var F = i9(Dq(w.R))
        var X = window,
          c = X.document
        var g = 0
        if (c) {
          ...
          if (Y && g) {
            if (((X = br(X).height), NX(c) && Y.scrollHeight)) {
              g = Y.scrollHeight != X ? Y.scrollHeight : Y.offsetHeight
            } else {
              c = Y.scrollHeight
              var y = Y.offsetHeight
              Y.clientHeight != y &&
                ((c = g.scrollHeight), (y = g.offsetHeight))
        ...
        Y = Math.min(
          Math.max(
            Math.min(
              Math.max(
                Math.min(
                  Math.max(g.I - 0.5 * F.height, SZ(document).I + 10),
                  SZ(document).I + KO().height - F.height - 10
                ),
                g.I - 0.9 * F.height
              ),
              g.I - 0.1 * F.height
    ...
    eU = function (w, F, X) {
      P(
        XS('g-recaptcha-bubble-arrow', w.R),
        function (w, g) {
  ...
  var BH = new mU('sitekey', null, 'k', !0),
    xz
  if (d.window) {
    var Qb = new Sg(window.location)
    Qb.Y = ''
    Qb.K != null ||
      (Qb.R == 'https' ? lt(Qb, 443) : Qb.R == 'http' && lt(Qb, 80))
    var rx = Qb.toString().match(T3),
      fO = rx[1],
      LO = rx[2],
      HH = rx[3],
      nO = rx[4],
  ...
  var ZZ = new mU(
    ...
    CO = new mU('stoken', null, 'stoken'),
    tc = new mU('badge', null, 'badge'),
    i_ = new mU('action', null, 'sa'),
    Uu = new mU('callback'),
    RE = new mU('expired-callback'),
    Mr = new mU('error-callback'),
    Jc = new mU('tabindex', '0'),
    G5 = new mU('bind'),
    $z = new mU('isolated', null),
    Nr = {
      da: BH,
    ...
    SU = function (w) {
      ...
      this.R = w
      w = b_(this)
      if (w.length > 0) throw Error('Missing required parameters: ' + w.join())
    },
    b_ = function (w) {
      var F = []
      P(
  ...
  var FW = function (w) {
      return J(
        '<div><div></div>' +
          N(T5({ id: w.Xu, name: w.fK, display: !1 })) +
          '</div>'
      )
    },
    XW = function (w) {
  ...
  gN.prototype.K = function (w) {
    ...
    w
      ? Eu.prototype.K.call(this, w)
      : F > 1.5 * jU.normal.width
        ? Eu.prototype.K.call(this, 'bubble')
        : Eu.prototype.K.call(this)
  }
  gN.prototype.vd = D('A')
  var Yi = function (w) {
      var F = w.Xu,
    ...
    yP = function (w) {
      ...
      F = w.LZ
        ? F +
          '<div>reCAPTCHA was unable to load. Please check your internet connection and reload to get a reCAPTCHA challenge.</div>'
        : F +
  ...
  var aK = {},
    ...
    (aK.inline = { 'box-shadow': '0px 0px 5px gray' }),
    (aK.none = { display: 'none' }),
    aK),
    pT = ['bottomleft', 'bottomright'],
    TM = new Tz(DS, '.grecaptcha-badge:hover { right: 4px !important }'),
    zM = new Tz(DS, '.grecaptcha-badge:hover { left: 4px !important }'),
    dN = function (w, F, X) {
      Eu.call(this, w, F)
      this.LI = null
      this.Gn = X
  ...
  dN.prototype.render = function (w, F, X, c) {
    ...
    g == 'bottomright' ? oA(OW(TM)) : g == 'bottomleft' && oA(OW(zM))
    Qq(this.LI, DR[g])
  }
  ...
  var EG = function (w, F) {
    var X = null
    if (F == 'bottomright') X = 'right'
    else if (F == 'bottomleft') X = 'left'
    else return
    w.U(
      w.LI,
      'mouseenter',
  ...
  var IK = function () {
      return (
        ...
        (document.readyState == 'interactive' && !x)
      )
    },
    sG = function () {
      var w = KT
  ...
  z.k2 = function (w) {
    ;(xi(this.id).value = w.response) &&
      this.jv.has(Uu) &&
      qr(this.jv, Uu, !0)(w.response)
  }
  z.pZ = function () {
    xi(this.id).value = ''
  ...
  var ki = function (w, F) {
    ...
    rN = function (w, F, X) {
      ...
      if (X) {
        X = w
        var c = X.getAttribute('data-sitekey'),
          g = X.getAttribute('data-type'),
          Y = X.getAttribute('data-theme'),
          y = X.getAttribute('data-size'),
          p = X.getAttribute('data-tabindex'),
          T = X.getAttribute('data-stoken'),
          K = X.getAttribute('data-bind'),
          B = X.getAttribute('data-preload'),
          r = X.getAttribute('data-badge'),
          fw = X.getAttribute('data-s'),
          zn = X.getAttribute('data-pool'),
          dR = X.getAttribute('data-content-binding'),
          Lw = X.getAttribute('data-action')
        c = {
          sitekey: c,
          type: g,
          theme: Y,
        ...
        ;(g = X.getAttribute('data-expired-callback')) &&
          (c['expired-callback'] = g)
        ;(X = X.getAttribute('data-error-callback')) &&
          (c['error-callback'] = X)
        X = c
        F && li(X, F)
      } else X = F
      ...
      if (
        w.tagName == 'BUTTON' ||
        (w.tagName == 'INPUT' && (w.type == 'submit' || w.type == 'button'))
      ) {
        ;(X[G5.getName()] = w),
        (F = Fm(document, 'DIV')),
    ...
    AG = function (w) {
      ...
      typeof w === 'string'
        ? (F = R9(document, w))
        : V(w) && w.nodeType == 1 && (F = w)
      return F
    },
    fT = function () {
      Array.from(XS('g-recaptcha'))
        .filter(function (w) {
          return !QP(w)
        })
        .forEach(function (w) {
    ...
    nT = function (w, F) {
      ...
      if (V(w)) {
        ...
        if (((X = window.___grecaptcha_cfg.I1[w]), X == null)) {
          throw Error('Invalid site key or not loaded in api.js: ' + w)
        }
      } else X = w
  ...
  var GM = function (w) {
    ...
    LT = function () {
      for (var w = 0; w < window.___grecaptcha_cfg.count; w++) {
        if (document.body.contains(window.___grecaptcha_cfg.clients[w].Di)) {
          return w
        }
      }
    ...
    KT = function () {
      ...
      F && k(F) && (w = w.concat(F))
      w = T0(w)
      for (F = w.next(); !F.done; F = w.next()) {
        if (((F = F.value), h(window[F]))) window[F]()
        else {
          h(F)
            ? F()
            : F &&
              console.log(
                "reCAPTCHA couldn't find user-provided function: " + F
              )
        }
      }
    }
  ...
  d.window &&
    d.window.__google_recaptcha_client &&
    (d.window.___grecaptcha_cfg || N9('___grecaptcha_cfg', {}),
    d.window.___grecaptcha_cfg.clients ||
      ((d.window.___grecaptcha_cfg.count = 0),
      (d.window.___grecaptcha_cfg.q6 = 0),
      (d.window.___grecaptcha_cfg.clients = {}),
      (d.window.___grecaptcha_cfg.I1 = {})),
    N9('grecaptcha.render', rN),
    N9('grecaptcha.reset', uy),
    N9('grecaptcha.getResponse', GM),
    N9('grecaptcha.execute', nT),
    sG())
  if (d.window && d.window.test_signature) {
    var ZR = d.window.document.getElementById('recaptcha-widget-signature')
    if (ZR) {
      var CT = d.window.document,
        tG = CT.createElement('div')
  ...
  var by = function (w) {
      ...
      w.U(w.H, 'f', function () {
        wK(
          this,
          new $i(this.F.KI(), Hy(this.H.ev)),
          v(function (w) {
            if (w.Na() != null) this.b2()
            else {
              w.KI() && Fc(this, w.KI())
              var F = this.H.ev
              F.Os = !1
              ...
              g = T0(g)
              for (var Y = g.next(); !Y.done; Y = g.next()) {
                ;(Y = Y.value), c.push(F.gO(w.KI(), Y))
              }
              F.ab(c, o1(w, Gn, 4))
              Lv(F)
            }
  ...
  var cV = function (w) {
    ...
    qS = function (w, F, X) {
      ...
      w.F.l = e()
      d.clearTimeout(w.A)
      if (w.F.A == 'uninitialized' && w.F.Y != null) gK(w, w.F.Y)
      else {
        var c = v(function (w) {
          this.F.J.send(w).then(
            function (w) {
              gK(this, w, !1)
            },
            this.b2,
        ...
        X
          ...
          : w.F.R.CY() == 'embeddable'
            ...
            : ((X = v(function (w) {
              c(new td(F, this.F.KI(), w))
            }, w)),
            w.F.K.execute().then(X, X))
      }
    },
    gK = function (w, F, X) {
      if (F.Na() != null) w.F.R.tA(F.Na())
      else {
        Fc(w, F.KI())
        w.F.A = 'active'
        if (L(F, 8)) {
  ...
  SW.prototype.J = function () {
    this.F.A == 'active' && (cV(this), this.F.R.x2(), this.H.ev.zn(!1))
  }
  SW.prototype.B = function () {
    d.clearTimeout(this.A)
    var w = v(this.Y, this)
    this.F.R.CY() == 'embeddable'
      ? this.F.R.sP(v(M9(w, null), this), this.F.KI(), !0)
      : this.F.K.execute().then(w, function () {
        return w()
      })
  }
  ...
  SW.prototype.K = function (w) {
    if (w.Na() != null) cV(this), this.F.R.tA(w.Na())
    else {
      var F = L(w, 1)
      Fc(this, F)
      L(w, 2)
        ? ((w = w.sW()), this.F.R.Sd(F, w), WX(this, !1))
        : gK(this, n(w, CY, 7), this.H.ev.getName() != 'nocaptcha')
    }
  }
  var Fc = function (w, F) {
    w.F.D = F
  ...
  z.ha = function (w, F) {
    if (window.RecaptchaEmbedder && RecaptchaEmbedder.onShow) {
      RecaptchaEmbedder.onShow(w, F.width, F.height)
    }
    return Promise.resolve(new $2(w, F))
  }
  z.Ga = function (w) {
    if (window.RecaptchaEmbedder && RecaptchaEmbedder.onResize) {
      RecaptchaEmbedder.onResize(w.width, w.height)
    }
  ...
  z.Sd = function (w) {
    window.RecaptchaEmbedder &&
      ...
      RecaptchaEmbedder.verifyCallback(w)
  }
  z.x2 = function () {
  ...
  z.sP = function (w, F, X) {
    ...
    window.RecaptchaEmbedder &&
      ...
      RecaptchaEmbedder.requestToken(F, X)
  }
  z.CY = Xh('embeddable')
  var aN = function (w) {
    U.call(this, w)
